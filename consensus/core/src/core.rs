...
#[cfg(test)]
use crate::{block_verifier::NoopBlockVerifier, storage::mem_store::MemStore, CommitConsumer, TransactionClient};
...
impl Core {
    ...
    pub(crate) fn add_certified_commits(
        ...
        let blocks = certified_commits.commits().iter().flat_map(|commit| commit.blocks()).cloned().collect::<Vec<_>>();
    ...
    fn validate_certified_commits(&mut self, commits: Vec<CertifiedCommit>) -> ConsensusResult<Vec<CertifiedCommit>> {
    ...
    fn try_commit(&mut self, mut certified_commits: Vec<CertifiedCommit>) -> ConsensusResult<Vec<CommittedSubDag>> {
        ...
        loop {
            ...
            let (mut decided_leaders, decided_certified_commits): (Vec<DecidedLeader>, Vec<CertifiedCommit>) =
                self.try_decide_certified(&mut certified_commits, commits_until_update).into_iter().unzip();
    ...
    pub(crate) fn set_propagation_delay_and_quorum_rounds(
        ...
        self.ancestor_state_manager.set_quorum_rounds_per_authority(received_quorum_rounds, accepted_quorum_rounds);
    ...
    fn smart_ancestors_to_propose(
        ...
        for (score, ancestor) in excluded_ancestors.iter() {
            ...
            let mut accepted_low_quorum_round =
                self.ancestor_state_manager.accepted_quorum_round_per_authority[excluded_author].0;
...
impl CoreTextFixture {
    fn new(
        ...
        Self { core, signal_receivers, block_receiver, commit_receiver, store }
    }
}
...
mod test {
    ...
    async fn test_core_try_new_block_leader_timeout() {
        ...
        for round in 1 ..= 3 {
            ...
            for core_fixture in cores.iter_mut() {
                ...
                core_fixture.core.add_blocks(last_round_blocks.clone()).unwrap();
    ...
    async fn test_smart_ancestor_selection() {
        ...
        core.set_propagation_delay_and_quorum_rounds(
            0,
            vec![(16, 16), (16, 16), (16, 16), (16, 16), (16, 16), (16, 16), (16, 16)],
            vec![(16, 16), (16, 16), (16, 16), (16, 16), (16, 16), (16, 16), (16, 16)],
        );

        builder.layer(17).authorities(vec![AuthorityIndex::new_for_test(0)]).skip_block().build();
    ...
    async fn test_validate_certified_commits() {
        ...
        let certified_commits = core.validate_certified_commits(certified_commits.clone()).unwrap();
        ...
        let err = core.validate_certified_commits(certified_commits.clone()).unwrap_err();
        match err {
