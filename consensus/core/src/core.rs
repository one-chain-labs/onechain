...
impl Core {
    ...
    fn try_new_block(&mut self, force: bool) -> Option<ExtendedBlock> {
        ...
        self.round_tracker.write().update_from_verified_block(&extended_block);
...
impl CoreTextFixture {
    async fn new(
        ...
        let transaction_certifier =
            TransactionCertifier::new(context.clone(), Arc::new(NoopBlockVerifier {}), dag_state.clone(), blocks_sender);
