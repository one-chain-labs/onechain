...
impl CommitConsumer {
    pub fn new(
    ...
    ) -> (Self, UnboundedReceiver<CommittedSubDag>, UnboundedReceiver<Vec<(VerifiedBlock, Vec<TransactionIndex>)>>) {
        ...
        (
            Self { commit_sender, transaction_sender, last_processed_commit_index, monitor },
            commit_receiver,
