...
use sui_types::{base_types::ObjectID, move_package::UpgradePolicy};
...
fn compare_packages(
    ...
    if diags.is_empty() {
        ...
        Err(anyhow!(
            ...
            String::from_utf8(report_diagnostics_to_buffer(&new_package.package.file_map, sorted_diags, use_colors()))
