...
one client --client.config $CONFIG chain-identifier > chain_id_1.txt 2>&1
...
one client --client.config $CONFIG chain-identifier > chain_id_2.txt 2>&1
echo "Command executed"
...
one client --client.config $CONFIG objects > objects_output.txt 2>&1
echo "Command executed"
