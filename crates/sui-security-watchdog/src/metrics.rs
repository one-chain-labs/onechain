...
impl WatchdogMetrics {
    ...
    pub fn new(registry: &Registry) -> Self {
        Self { registry: registry.clone(), metrics: Mutex::new(HashMap::new()) }
    }
    ...
    pub async fn get(&self, metric_name: &str) -> anyhow::Result<IntGauge> {
        ...
        let metric = metrics
            ...
            .or_insert_with(|| register_int_gauge_with_registry!(metric_name, metric_name, &self.registry).unwrap());
        Ok(metric.clone())
    }
