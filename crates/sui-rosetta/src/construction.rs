...
pub async fn metadata(
    ...
    let TransactionObjectData { gas_coins, extra_gas_coins, objects, total_oct_balance, budget } =
        option.internal_operation.try_fetch_needed_objects(&context.client, Some(gas_price), budget).await?;
