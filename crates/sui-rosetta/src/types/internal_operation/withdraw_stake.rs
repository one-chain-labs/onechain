...
impl TryConstructTransaction for WithdrawStake {
    async fn try_fetch_needed_objects(
        ...
        let responses =
            client.read_api().multi_get_object_with_options(stake_ids, SuiObjectDataOptions::default()).await?;
        ...
        Ok(TransactionObjectData { gas_coins, extra_gas_coins: vec![], objects: stake_refs, total_oct_balance, budget })
    }
}
