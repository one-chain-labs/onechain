...
impl SuiTxValidator {
    ...
    async fn vote_transaction(&self, epoch_store: &Arc<AuthorityPerEpochStore>, tx: Box<Transaction>) -> SuiResult<()> {
        ...
        self.authority_state.handle_transaction_v2(epoch_store, tx).await?;
