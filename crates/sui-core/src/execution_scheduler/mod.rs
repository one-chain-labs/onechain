...
pub(crate) trait ExecutionSchedulerAPI {
    ...
    fn enqueue(&self, certs: Vec<VerifiedExecutableTransaction>, epoch_store: &Arc<AuthorityPerEpochStore>) {
    ...
    /// with shared objects!
    fn enqueue_certificates(&self, certs: Vec<VerifiedCertificate>, epoch_store: &Arc<AuthorityPerEpochStore>) {
...
impl ExecutingGuard {
    pub fn new(num_executing_certificates: IntGauge) -> Self {
        ...
        Self { num_executing_certificates }
    }
}
