    ...
    C: AuthorityAPI + Send + Sync + Clone + 'static,
{
    ...
    pub async fn submit_transaction(
        ...
        let response = self.authority_client.submit_transaction(request, client_addr).await?;
    ...
    fn verify_submit_transaction_response(
        &self,
        SubmitTxResponse { effects, events, input_objects, output_objects, auxiliary_data }: SubmitTxResponse,
        ...
        Ok(SubmitTxResponse { effects, events, input_objects, output_objects, auxiliary_data })
    }
