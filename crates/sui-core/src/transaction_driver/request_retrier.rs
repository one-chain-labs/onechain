...
mod tests {
    ...
    async fn test_next_target() {
        ...
        let mut retrier = RequestRetrier::new(&auth_agg, &client_monitor, TxType::SingleWriter, vec![]);
    ...
    async fn test_allowed_validators() {
        ...
        println!("Case 1. Mix of unknown validators and one known validator");
        {
            ...
            let retrier = RequestRetrier::new(&auth_agg, &client_monitor, TxType::SingleWriter, allowed_validators);
