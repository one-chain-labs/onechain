...
fn accumulate_effects_v1<T, S>(store: S, effects: &[TransactionEffects], protocol_config: &ProtocolConfig) -> Accumulator
where
    S: std::ops::Deref<Target = T>,
    T: AccumulatorStore + ?Sized,
{
...
impl StateAccumulator {
    ...
    pub fn accumulate_effects(&self, effects: &[TransactionEffects], protocol_config: &ProtocolConfig) -> Accumulator {
