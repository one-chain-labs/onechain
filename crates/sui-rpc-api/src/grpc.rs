...
impl crate::proto::node::v2::node_service_server::NodeService for crate::RpcService {
    async fn get_node_info(
        ...
        self.get_node_info().map(tonic::Response::new).map_err(Into::into)
    }

    async fn get_committee(
        &self,
        request: tonic::Request<crate::proto::node::v2::GetCommitteeRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2::GetCommitteeResponse>, tonic::Status> {
        let committee = self.get_committee(request.into_inner().epoch)?;

        crate::proto::node::v2::GetCommitteeResponse { committee: Some(committee.into()) }
    ...
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2::GetObjectResponse>, tonic::Status> {
        self.get_object(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn get_transaction(
        &self,
        request: tonic::Request<crate::proto::node::v2::GetTransactionRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2::GetTransactionResponse>, tonic::Status> {
        self.get_transaction(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn get_checkpoint(
        &self,
        request: tonic::Request<crate::proto::node::v2::GetCheckpointRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2::GetCheckpointResponse>, tonic::Status> {
        self.get_checkpoint(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn get_full_checkpoint(
        &self,
        request: tonic::Request<crate::proto::node::v2::GetFullCheckpointRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2::GetFullCheckpointResponse>, tonic::Status> {
        self.get_full_checkpoint(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn execute_transaction(
        &self,
        request: tonic::Request<crate::proto::node::v2::ExecuteTransactionRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2::ExecuteTransactionResponse>, tonic::Status> {
        self.execute_transaction(request.into_inner()).await.map(tonic::Response::new).map_err(Into::into)
    }
}
...
#[tonic::async_trait]
impl crate::proto::node::v2alpha::subscription_service_server::SubscriptionService for SubscriptionServiceHandle {
    /// Server streaming response type for the SubscribeCheckpoints method.
    type SubscribeCheckpointsStream =
        Pin<Box<dyn tokio_stream::Stream<Item = Result<SubscribeCheckpointsResponse, tonic::Status>> + Send>>;
    ...
    for path in &read_mask.paths {
        ...
        match component {
            ...
            "transactions" => {
                ...
                for (src, dst) in checkpoint.transactions.iter().zip(response.transactions.iter_mut()) {
                    match component {
                        ...
                        "input_objects" => {
                            ...
                            if dst.input_objects.len() != src.input_objects.len() {
                                dst.input_objects = vec![Default::default(); src.input_objects.len()];
                            }

                            for (src, dst) in src.input_objects.iter().zip(dst.input_objects.iter_mut()) {
                                match component {
                        ...
                        "output_objects" => {
                            ...
                            if dst.output_objects.len() != src.output_objects.len() {
                                dst.output_objects = vec![Default::default(); src.output_objects.len()];
                            }

                            for (src, dst) in src.output_objects.iter().zip(dst.output_objects.iter_mut()) {
                                match component {
                                    "object" => dst.object = src.object.clone(),
                                    "object_bcs" => dst.object_bcs = src.object_bcs.clone(),
                                    // Ignore unknown field
...
impl crate::proto::node::v2alpha::node_service_server::NodeService for crate::RpcService {
    async fn get_coin_info(
        ...
        self.get_coin_info(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn list_dynamic_fields(
        &self,
        request: tonic::Request<crate::proto::node::v2alpha::ListDynamicFieldsRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2alpha::ListDynamicFieldsResponse>, tonic::Status>
    {
        self.list_dynamic_fields(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn list_account_objects(
        &self,
        request: tonic::Request<crate::proto::node::v2alpha::ListAccountObjectsRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2alpha::ListAccountObjectsResponse>, tonic::Status>
    {
        self.list_account_objects(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn get_protocol_config(
        &self,
        request: tonic::Request<crate::proto::node::v2alpha::GetProtocolConfigRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2alpha::GetProtocolConfigResponse>, tonic::Status>
    {
        self.get_protocol_config(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn get_gas_info(
        &self,
        request: tonic::Request<crate::proto::node::v2alpha::GetGasInfoRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2alpha::GetGasInfoResponse>, tonic::Status> {
        self.get_gas_info(request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }

    async fn simulate_transaction(
        &self,
        request: tonic::Request<crate::proto::node::v2alpha::SimulateTransactionRequest>,
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2alpha::SimulateTransactionResponse>, tonic::Status>
    {
        ...
        let transaction = if let Some(bcs) = request.transaction_bcs {
            bcs::from_bytes(bcs.bcs())
                .map_err(|_| tonic::Status::new(tonic::Code::InvalidArgument, "invalid transaction bcs"))?
        } else {
            return Err(tonic::Status::new(tonic::Code::InvalidArgument, "`transaction_bcs` must be provided"));
        };
        ...
        let response = crate::proto::node::v2alpha::SimulateTransactionResponse {
            ...
            events_bcs: response.events.map(|events| Bcs::serialize(&events)).transpose().unwrap(),
            balance_changes,
        };
        Ok(tonic::Response::new(response))
    }
    ...
    ) -> std::result::Result<tonic::Response<crate::proto::node::v2alpha::ResolveTransactionResponse>, tonic::Status>
    {
        let request = request.into_inner();
        ...
        let parameters = crate::types::ResolveTransactionQueryParameters {
            simulate: read_mask.paths.iter().any(|path| path.starts_with("simulation")),
            simulate_transaction_parameters: simulate_parameters,
        };
        let unresolved_transaction = serde_json::from_str(&request.unresolved_transaction.unwrap_or_default())
            .map_err(|_| tonic::Status::new(tonic::Code::InvalidArgument, "invalid unresolved_transaction"))?;
        ...
        let simulation = response.simulation.map(|simulation| {
            ...
            crate::proto::node::v2alpha::SimulateTransactionResponse {
                ...
                events_bcs: simulation.events.map(|events| Bcs::serialize(&events)).transpose().unwrap(),
                balance_changes,
            }
        });
