...
impl LedgerService for RpcService {
    ...
    async fn get_object(
        ...
        get_object::get_object(self, request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }
    ...
    async fn batch_get_objects(
        ...
        get_object::batch_get_objects(self, request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }
    ...
    async fn get_transaction(
        ...
        get_transaction::get_transaction(self, request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }
    ...
    async fn batch_get_transactions(
        ...
        get_transaction::batch_get_transactions(self, request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }
    ...
    async fn get_checkpoint(
        ...
        get_checkpoint::get_checkpoint(self, request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }
    ...
    async fn get_epoch(
        ...
        get_epoch::get_epoch(self, request.into_inner()).map(tonic::Response::new).map_err(Into::into)
    }
}
