...
fn render_object_to_json(service: &crate::RpcService, object: &sui_types::object::Object) -> Option<prost_types::Value> {
    object
        .data
        .try_as_move()
        .and_then(|move_object| render_json(service, &move_object.type_().clone().into(), move_object.contents()))
}
