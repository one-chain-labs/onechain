...
fn resolve_as_bool(buf: &mut Vec<u8>, value: &Value) -> Result<()> {
    let b: bool = match &value.kind {
        ...
        _ => {
            return Err(RpcError::new(tonic::Code::InvalidArgument, "literal cannot be resolved into type bool"));
        }
    };
...
fn resolve_as_address(buf: &mut Vec<u8>, value: &Value) -> Result<()> {
    let address = match &value.kind {
        ...
        _ => {
            return Err(RpcError::new(tonic::Code::InvalidArgument, "literal cannot be resolved into type address"));
        }
    };
...
fn resolve_as_string(buf: &mut Vec<u8>, value: &Value) -> Result<()> {
    match &value.kind {
        ...
        _ => {
            return Err(RpcError::new(tonic::Code::InvalidArgument, "literal cannot be resolved into string"));
        }
    };
...
fn resolve_as_option(buf: &mut Vec<u8>, type_: &Type, value: &Value) -> Result<()> {
    match &value.kind {
        ...
        _ => {
            return Err(RpcError::new(tonic::Code::InvalidArgument, "literal cannot be resolved into Option"));
        }
    }
