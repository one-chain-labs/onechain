...
pub fn resolve_transaction(
    ...
    let ptb = unresolved_transaction.kind().programmable_transaction_opt().ok_or_else(|| {
...
impl TryFrom<&sui_rpc::proto::sui::rpc::v2::ObjectReference> for UnresolvedObjectReference {
    ...
    fn try_from(value: &sui_rpc::proto::sui::rpc::v2::ObjectReference) -> Result<Self, Self::Error> {
