...
pub async fn execute_transaction(
    ...
    let executed_transaction = {
        ...
        message.digest =
            read_mask.contains(ExecutedTransaction::DIGEST_FIELD.name).then(|| transaction.digest().to_string());
        ...
        message.objects =
            read_mask.subtree(ExecutedTransaction::path_builder().objects().objects().finish()).map(|mask| {
