...
impl Transaction {
    const BCS_FIELD: &'static MessageField = &MessageField::new("bcs").with_message_fields(super::Bcs::FIELDS);
...
impl MessageMerge<sui_sdk_types::Transaction> for Transaction {
    fn merge(&mut self, source: sui_sdk_types::Transaction, mask: &crate::field_mask::FieldMaskTree) {
...
impl MessageMerge<&Transaction> for Transaction {
    fn merge(&mut self, source: &Transaction, mask: &crate::field_mask::FieldMaskTree) {
        let Transaction { bcs, digest, version, kind, sender, gas_payment, expiration } = source;
...
impl TryFrom<&Transaction> for sui_sdk_types::Transaction {
    ...
    fn try_from(value: &Transaction) -> Result<Self, Self::Error> {
        ...
        let kind = value.kind.as_ref().ok_or_else(|| TryFromProtoError::missing("kind"))?.try_into()?;
        ...
        let gas_payment =
            value.gas_payment.as_ref().ok_or_else(|| TryFromProtoError::missing("gas_payment"))?.try_into()?;

        let expiration =
            value.expiration.as_ref().ok_or_else(|| TryFromProtoError::missing("expiration"))?.try_into()?;
...
impl TryFrom<&super::GasPayment> for sui_sdk_types::GasPayment {
    ...
    fn try_from(value: &super::GasPayment) -> Result<Self, Self::Error> {
        let objects = value.objects.iter().map(TryInto::try_into).collect::<Result<_, _>>()?;
        ...
        let owner = value
            ...
            .parse()
            .map_err(TryFromProtoError::from_error)?;
        let price = value.price.ok_or_else(|| TryFromProtoError::missing("price"))?;
        let budget = value.budget.ok_or_else(|| TryFromProtoError::missing("budget"))?;
        Ok(Self { objects, owner, price, budget })
    }
}
    ...
    fn try_from(value: &super::TransactionExpiration) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            TransactionExpirationKind::Unknown => {
                return Err(TryFromProtoError::from_error("unknown TransactionExpirationKind"))
            }
...
impl From<super::ProgrammableTransaction> for super::TransactionKind {
    fn from(value: super::ProgrammableTransaction) -> Self {
        Self { kind: Some(super::transaction_kind::Kind::ProgrammableTransaction(value)) }
    }
}
...
impl TryFrom<&super::TransactionKind> for sui_sdk_types::TransactionKind {
    ...
    fn try_from(value: &super::TransactionKind) -> Result<Self, Self::Error> {
        ...
        match value.kind.as_ref().ok_or_else(|| TryFromProtoError::missing("kind"))? {
            ...
            Kind::ConsensusCommitPrologueV1(prologue) => Self::ConsensusCommitPrologue(prologue.try_into()?),
            Kind::AuthenticatorStateUpdate(update) => Self::AuthenticatorStateUpdate(update.try_into()?),
            Kind::EndOfEpoch(super::EndOfEpochTransaction { transactions }) => {
                Self::EndOfEpoch(transactions.iter().map(TryInto::try_into).collect::<Result<_, _>>()?)
            }
            Kind::RandomnessStateUpdate(update) => Self::RandomnessStateUpdate(update.try_into()?),
            Kind::ConsensusCommitPrologueV2(prologue) => Self::ConsensusCommitPrologueV2(prologue.try_into()?),
            Kind::ConsensusCommitPrologueV3(prologue) => Self::ConsensusCommitPrologueV3(prologue.try_into()?),
            Kind::ConsensusCommitPrologueV4(prologue) => Self::ConsensusCommitPrologueV4(prologue.try_into()?),
        }
        .pipe(Ok)
    }
}
...
impl TryFrom<&super::ConsensusCommitPrologue> for sui_sdk_types::ConsensusCommitPrologue {
    ...
    fn try_from(value: &super::ConsensusCommitPrologue) -> Result<Self, Self::Error> {
        ...
        Ok(Self { epoch, round, commit_timestamp_ms })
    }
}
...
impl TryFrom<&super::ConsensusCommitPrologue> for sui_sdk_types::ConsensusCommitPrologueV2 {
    ...
    fn try_from(value: &super::ConsensusCommitPrologue) -> Result<Self, Self::Error> {
        ...
        Ok(Self { epoch, round, commit_timestamp_ms, consensus_commit_digest })
    }
}
...
impl From<sui_sdk_types::ConsensusCommitPrologueV3> for super::ConsensusCommitPrologue {
    fn from(value: sui_sdk_types::ConsensusCommitPrologueV3) -> Self {
        Self {
            ...
            consensus_determined_version_assignments: Some(value.consensus_determined_version_assignments.into()),
            additional_state_digest: None,
        }
    }
}
...
impl From<sui_sdk_types::ConsensusCommitPrologueV4> for super::ConsensusCommitPrologue {
    fn from(
        ...
        Self {
            ...
            sub_dag_index,
            consensus_determined_version_assignments: Some(consensus_determined_version_assignments.into()),
...
impl From<sui_sdk_types::ConsensusDeterminedVersionAssignments> for super::ConsensusDeterminedVersionAssignments {
    fn from(value: sui_sdk_types::ConsensusDeterminedVersionAssignments) -> Self {
        ...
        let version = match value {
            CanceledTransactions { canceled_transactions } => {
                message.canceled_transactions = canceled_transactions.into_iter().map(Into::into).collect();
                1
            }
            CanceledTransactionsV2 { canceled_transactions } => {
                message.canceled_transactions = canceled_transactions.into_iter().map(Into::into).collect();
                2
            }
        };
...
impl TryFrom<&super::ConsensusDeterminedVersionAssignments> for sui_sdk_types::ConsensusDeterminedVersionAssignments {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &super::ConsensusDeterminedVersionAssignments) -> Result<Self, Self::Error> {
        match value.version() {
            ...
            _ => return Err(TryFromProtoError::from_error("unknown ConsensusDeterminedVersionAssignments version")),
        }
        .pipe(Ok)
    }
}
...
impl From<sui_sdk_types::CanceledTransaction> for super::CanceledTransaction {
    fn from(value: sui_sdk_types::CanceledTransaction) -> Self {
        Self {
            ...
            version_assignments: value.version_assignments.into_iter().map(Into::into).collect(),
        }
    }
}
...
impl TryFrom<&super::CanceledTransaction> for sui_sdk_types::CanceledTransaction {
    ...
    fn try_from(value: &super::CanceledTransaction) -> Result<Self, Self::Error> {
        ...
        let version_assignments = value.version_assignments.iter().map(TryInto::try_into).collect::<Result<_, _>>()?;

        Ok(Self { digest, version_assignments })
    }
}
...
impl From<sui_sdk_types::VersionAssignment> for super::VersionAssignment {
    fn from(value: sui_sdk_types::VersionAssignment) -> Self {
        Self { object_id: Some(value.object_id.to_string()), start_version: None, version: Some(value.version) }
    }
}
...
impl TryFrom<&super::VersionAssignment> for sui_sdk_types::VersionAssignmentV2 {
    ...
    fn try_from(value: &super::VersionAssignment) -> Result<Self, Self::Error> {
        let object_id = value
            ...
            .parse()
            .map_err(TryFromProtoError::from_error)?;
        let start_version = value.start_version.ok_or_else(|| TryFromProtoError::missing("version"))?;
        let version = value.version.ok_or_else(|| TryFromProtoError::missing("version"))?;

        Ok(Self { object_id, start_version, version })
    }
}
...
impl From<sui_sdk_types::RandomnessStateUpdate> for super::RandomnessStateUpdate {
    fn from(value: sui_sdk_types::RandomnessStateUpdate) -> Self {
        Self {
            ...
            randomness_object_initial_shared_version: Some(value.randomness_obj_initial_shared_version),
        }
    }
}
...
impl TryFrom<&super::RandomnessStateUpdate> for sui_sdk_types::RandomnessStateUpdate {
    ...
    fn try_from(
        ...
        let randomness_round = randomness_round.ok_or_else(|| TryFromProtoError::missing("randomness_round"))?;
        let random_bytes = random_bytes.as_ref().ok_or_else(|| TryFromProtoError::missing("random_bytes"))?.to_vec();
        let randomness_obj_initial_shared_version = randomness_object_initial_shared_version
            .ok_or_else(|| TryFromProtoError::missing("randomness_object_initial_shared_version"))?;
        Ok(Self { epoch, randomness_round, random_bytes, randomness_obj_initial_shared_version })
    }
}
...
impl From<sui_sdk_types::AuthenticatorStateUpdate> for super::AuthenticatorStateUpdate {
    fn from(value: sui_sdk_types::AuthenticatorStateUpdate) -> Self {
        Self {
            ...
            authenticator_object_initial_shared_version: Some(value.authenticator_obj_initial_shared_version),
        }
    }
}
...
impl TryFrom<&super::AuthenticatorStateUpdate> for sui_sdk_types::AuthenticatorStateUpdate {
    ...
    fn try_from(
        ...
        let authenticator_obj_initial_shared_version = authenticator_object_initial_shared_version
            .ok_or_else(|| TryFromProtoError::missing("authenticator_object_initial_shared_version"))?;
        Ok(Self {
            epoch,
            round,
            new_active_jwks: new_active_jwks.iter().map(TryInto::try_into).collect::<Result<_, _>>()?,
...
impl From<sui_sdk_types::Jwk> for super::Jwk {
    fn from(sui_sdk_types::Jwk { kty, e, n, alg }: sui_sdk_types::Jwk) -> Self {
        Self { kty: Some(kty), e: Some(e), n: Some(n), alg: Some(alg) }
    }
}
...
impl TryFrom<&super::Jwk> for sui_sdk_types::Jwk {
    ...
    fn try_from(super::Jwk { kty, e, n, alg }: &super::Jwk) -> Result<Self, Self::Error> {
        let kty = kty.as_ref().ok_or_else(|| TryFromProtoError::missing("kty"))?.into();
        let e = e.as_ref().ok_or_else(|| TryFromProtoError::missing("e"))?.into();
        let n = n.as_ref().ok_or_else(|| TryFromProtoError::missing("n"))?.into();
        let alg = alg.as_ref().ok_or_else(|| TryFromProtoError::missing("alg"))?.into();
        Ok(Self { kty, e, n, alg })
    }
}
...
impl From<sui_sdk_types::JwkId> for super::JwkId {
    fn from(sui_sdk_types::JwkId { iss, kid }: sui_sdk_types::JwkId) -> Self {
        Self { iss: Some(iss), kid: Some(kid) }
    }
}
...
impl TryFrom<&super::JwkId> for sui_sdk_types::JwkId {
    ...
    fn try_from(super::JwkId { iss, kid }: &super::JwkId) -> Result<Self, Self::Error> {
        let iss = iss.as_ref().ok_or_else(|| TryFromProtoError::missing("iss"))?.into();
        let kid = kid.as_ref().ok_or_else(|| TryFromProtoError::missing("kid"))?.into();
        Ok(Self { iss, kid })
    }
}
...
impl From<sui_sdk_types::ActiveJwk> for super::ActiveJwk {
    fn from(value: sui_sdk_types::ActiveJwk) -> Self {
        Self { id: Some(value.jwk_id.into()), jwk: Some(value.jwk.into()), epoch: Some(value.epoch) }
    }
}
...
impl TryFrom<&super::ActiveJwk> for sui_sdk_types::ActiveJwk {
    ...
    fn try_from(value: &super::ActiveJwk) -> Result<Self, Self::Error> {
        let jwk_id = value.id.as_ref().ok_or_else(|| TryFromProtoError::missing("id"))?.try_into()?;

        let jwk = value.jwk.as_ref().ok_or_else(|| TryFromProtoError::missing("jwk"))?.try_into()?;
...
impl From<sui_sdk_types::ChangeEpoch> for super::ChangeEpoch {
    fn from(value: sui_sdk_types::ChangeEpoch) -> Self {
        Self {
            ...
            epoch_start_timestamp: Some(crate::proto::timestamp_ms_to_proto(value.epoch_start_timestamp_ms)),
...
impl TryFrom<&super::ChangeEpoch> for sui_sdk_types::ChangeEpoch {
    ...
    fn try_from(
        ...
        let epoch = epoch.ok_or_else(|| TryFromProtoError::missing("epoch"))?;
        let protocol_version = protocol_version.ok_or_else(|| TryFromProtoError::missing("protocol_version"))?;
        let storage_charge = storage_charge.ok_or_else(|| TryFromProtoError::missing("storage_charge"))?;
        let computation_charge = computation_charge.ok_or_else(|| TryFromProtoError::missing("computation_charge"))?;
        ...
        Ok(Self {
            ...
            system_packages: system_packages.iter().map(TryInto::try_into).collect::<Result<_, _>>()?,
        })
    }
}
...
impl From<sui_sdk_types::EndOfEpochTransactionKind> for super::EndOfEpochTransactionKind {
    fn from(value: sui_sdk_types::EndOfEpochTransactionKind) -> Self {
        ...
        let kind = match value {
            ...
            BridgeCommitteeInit { bridge_object_version } => Kind::BridgeCommitteeInit(bridge_object_version),
            StoreExecutionTimeObservations(observations) => Kind::ExecutionTimeObservations(observations.into()),
        };
...
impl TryFrom<&super::EndOfEpochTransactionKind> for sui_sdk_types::EndOfEpochTransactionKind {
    ...
    fn try_from(value: &super::EndOfEpochTransactionKind) -> Result<Self, Self::Error> {
        ...
        match value.kind.as_ref().ok_or_else(|| TryFromProtoError::missing("kind"))? {
            Kind::ChangeEpoch(change_epoch) => Self::ChangeEpoch(change_epoch.try_into()?),
            Kind::AuthenticatorStateExpire(expire) => Self::AuthenticatorStateExpire(expire.try_into()?),
            ...
            Kind::BridgeStateCreate(digest) => {
                Self::BridgeStateCreate { chain_id: digest.parse().map_err(TryFromProtoError::from_error)? }
            }
            Kind::BridgeCommitteeInit(version) => Self::BridgeCommitteeInit { bridge_object_version: *version },
...
impl From<sui_sdk_types::AuthenticatorStateExpire> for super::AuthenticatorStateExpire {
    fn from(value: sui_sdk_types::AuthenticatorStateExpire) -> Self {
        Self {
            ...
            authenticator_object_initial_shared_version: Some(value.authenticator_object_initial_shared_version),
        }
    }
}
...
impl TryFrom<&super::AuthenticatorStateExpire> for sui_sdk_types::AuthenticatorStateExpire {
    ...
    fn try_from(
        ...
        let authenticator_object_initial_shared_version = authenticator_object_initial_shared_version
            .ok_or_else(|| TryFromProtoError::missing("authenticator_object_initial_shared_version"))?;
        Ok(Self { min_epoch, authenticator_object_initial_shared_version })
    }
}
...
impl From<sui_sdk_types::ExecutionTimeObservations> for super::ExecutionTimeObservations {
    fn from(value: sui_sdk_types::ExecutionTimeObservations) -> Self {
        match value {
            sui_sdk_types::ExecutionTimeObservations::V1(vec) => {
                Self { version: Some(1), observations: vec.into_iter().map(Into::into).collect() }
            }
        }
    }
}
...
impl TryFrom<&super::ExecutionTimeObservations> for sui_sdk_types::ExecutionTimeObservations {
    ...
    fn try_from(value: &super::ExecutionTimeObservations) -> Result<Self, Self::Error> {
        Ok(Self::V1(value.observations.iter().map(|observation| observation.try_into()).collect::<Result<_, _>>()?))
    }
}

impl From<(sui_sdk_types::ExecutionTimeObservationKey, Vec<sui_sdk_types::ValidatorExecutionTimeObservation>)>
    for super::ExecutionTimeObservation
{
    fn from(
        value: (sui_sdk_types::ExecutionTimeObservationKey, Vec<sui_sdk_types::ValidatorExecutionTimeObservation>),
    ) -> Self {
        ...
        let kind = match value.0 {
            ExecutionTimeObservationKey::MoveEntryPoint { package, module, function, type_arguments } => {
                message.move_entry_point = Some(super::MoveCall {
                    package: Some(package.to_string()),
                    module: Some(module),
                    function: Some(function),
                    type_arguments: type_arguments.into_iter().map(|ty| ty.to_string()).collect(),
                    arguments: Vec::new(),
                });
                ExecutionTimeObservationKind::MoveEntryPoint
            }
            ExecutionTimeObservationKey::TransferObjects => ExecutionTimeObservationKind::TransferObjects,
            ...
            ExecutionTimeObservationKey::MakeMoveVec => ExecutionTimeObservationKind::MakeMoveVector,
...
impl TryFrom<&super::ExecutionTimeObservation>
    for (sui_sdk_types::ExecutionTimeObservationKey, Vec<sui_sdk_types::ValidatorExecutionTimeObservation>)
{
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &super::ExecutionTimeObservation) -> Result<Self, Self::Error> {
        ...
        let key = match value.kind() {
            ExecutionTimeObservationKind::Unknown => {
                return Err(TryFromProtoError::from_error("unknown ExecutionTimeObservationKind"))
            }
            ExecutionTimeObservationKind::MoveEntryPoint => {
                let move_call = value
                    .move_entry_point
            ...
            ExecutionTimeObservationKind::TransferObjects => ExecutionTimeObservationKey::TransferObjects,
            ...
            ExecutionTimeObservationKind::MakeMoveVector => ExecutionTimeObservationKey::MakeMoveVec,
...
impl From<sui_sdk_types::ValidatorExecutionTimeObservation> for super::ValidatorExecutionTimeObservation {
...
impl TryFrom<&super::ValidatorExecutionTimeObservation> for sui_sdk_types::ValidatorExecutionTimeObservation {
    type Error = TryFromProtoError;
...
impl TryFrom<&super::ProgrammableTransaction> for sui_sdk_types::ProgrammableTransaction {
    ...
    fn try_from(value: &super::ProgrammableTransaction) -> Result<Self, Self::Error> {
        Ok(Self {
            inputs: value.inputs.iter().map(TryInto::try_into).collect::<Result<_, _>>()?,
            commands: value.commands.iter().map(TryInto::try_into).collect::<Result<_, _>>()?,
        })
    }
}
...
impl TryFrom<&super::Input> for sui_sdk_types::Input {
    ...
    fn try_from(value: &super::Input) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            InputKind::Pure => {
                Self::Pure { value: value.pure.as_ref().ok_or_else(|| TryFromProtoError::missing("pure"))?.to_vec() }
            }
            InputKind::ImmutableOrOwned => {
                let object_id = value
                    .object_id
            ...
            InputKind::Shared => {
                let object_id = value
                    ...
                    .parse()
                    .map_err(TryFromProtoError::from_error)?;
                let initial_shared_version = value.version.ok_or_else(|| TryFromProtoError::missing("version"))?;
                let mutable = value.mutable.ok_or_else(|| TryFromProtoError::missing("mutable"))?;
...
impl super::Argument {
    pub fn gas() -> Self {
        Self { kind: Some(super::argument::ArgumentKind::Gas.into()), input: None, result: None, subresult: None }
    }
...
impl TryFrom<&super::Argument> for sui_sdk_types::Argument {
    ...
    fn try_from(value: &super::Argument) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ArgumentKind::Unknown => return Err(TryFromProtoError::from_error("unknown ArgumentKind")),
            ArgumentKind::Gas => Self::Gas,
            ArgumentKind::Input => {
                let input = value.input.ok_or_else(|| TryFromProtoError::missing("input"))?.try_into()?;
                Self::Input(input)
            }
            ArgumentKind::Result => {
                let result = value.result.ok_or_else(|| TryFromProtoError::missing("result"))?.try_into()?;
...
impl TryFrom<&super::Command> for sui_sdk_types::Command {
    ...
    fn try_from(value: &super::Command) -> Result<Self, Self::Error> {
        ...
        match value.command.as_ref().ok_or_else(|| TryFromProtoError::missing("command"))? {
            Command::MoveCall(move_call) => Self::MoveCall(move_call.try_into()?),
            Command::TransferObjects(transfer_objects) => Self::TransferObjects(transfer_objects.try_into()?),
            ...
            Command::MakeMoveVector(make_move_vector) => Self::MakeMoveVector(make_move_vector.try_into()?),
...
impl TryFrom<&super::MoveCall> for sui_sdk_types::MoveCall {
    ...
    fn try_from(value: &super::MoveCall) -> Result<Self, Self::Error> {
        ...
        let type_arguments = value
            ...
            .collect::<Result<_, _>>()?;
        let arguments = value.arguments.iter().map(TryInto::try_into).collect::<Result<_, _>>()?;

        Ok(Self { package, module, function, type_arguments, arguments })
    }
}
...
impl From<sui_sdk_types::TransferObjects> for super::TransferObjects {
    fn from(value: sui_sdk_types::TransferObjects) -> Self {
        Self { objects: value.objects.into_iter().map(Into::into).collect(), address: Some(value.address.into()) }
    }
}
...
impl TryFrom<&super::TransferObjects> for sui_sdk_types::TransferObjects {
    ...
    fn try_from(value: &super::TransferObjects) -> Result<Self, Self::Error> {
        ...
        let address = value.address.as_ref().ok_or_else(|| TryFromProtoError::missing("address"))?.try_into()?;
...
impl From<sui_sdk_types::SplitCoins> for super::SplitCoins {
    fn from(value: sui_sdk_types::SplitCoins) -> Self {
        Self { coin: Some(value.coin.into()), amounts: value.amounts.into_iter().map(Into::into).collect() }
    }
}
...
impl TryFrom<&super::SplitCoins> for sui_sdk_types::SplitCoins {
    ...
    fn try_from(value: &super::SplitCoins) -> Result<Self, Self::Error> {
        let coin = value.coin.as_ref().ok_or_else(|| TryFromProtoError::missing("coin"))?.try_into()?;

        let amounts = value.amounts.iter().map(TryInto::try_into).collect::<Result<_, _>>()?;
...
impl TryFrom<&super::MergeCoins> for sui_sdk_types::MergeCoins {
    ...
    fn try_from(value: &super::MergeCoins) -> Result<Self, Self::Error> {
        ...
        let coins_to_merge = value.coins_to_merge.iter().map(TryInto::try_into).collect::<Result<_, _>>()?;

        Ok(Self { coin, coins_to_merge })
    }
}
...
impl TryFrom<&super::MakeMoveVector> for sui_sdk_types::MakeMoveVector {
    ...
    fn try_from(value: &super::MakeMoveVector) -> Result<Self, Self::Error> {
        let element_type =
            value.element_type.as_ref().map(|t| t.parse().map_err(TryFromProtoError::from_error)).transpose()?;

        let elements = value.elements.iter().map(TryInto::try_into).collect::<Result<_, _>>()?;

        Ok(Self { type_: element_type, elements })
    }
}
...
impl TryFrom<&super::Upgrade> for sui_sdk_types::Upgrade {
    ...
    fn try_from(value: &super::Upgrade) -> Result<Self, Self::Error> {
        ...
        let ticket = value.ticket.as_ref().ok_or_else(|| TryFromProtoError::missing("ticket"))?.try_into()?;

        Ok(Self { modules, dependencies, package, ticket })
    }
}
