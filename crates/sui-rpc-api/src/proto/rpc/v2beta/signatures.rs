...
impl From<sui_sdk_types::ValidatorCommitteeMember> for super::ValidatorCommitteeMember {
    fn from(value: sui_sdk_types::ValidatorCommitteeMember) -> Self {
        Self { public_key: Some(value.public_key.as_bytes().to_vec().into()), stake: Some(value.stake) }
    }
}
...
impl From<sui_sdk_types::ValidatorCommittee> for super::ValidatorCommittee {
    fn from(value: sui_sdk_types::ValidatorCommittee) -> Self {
        Self { epoch: Some(value.epoch), members: value.members.into_iter().map(Into::into).collect() }
    }
}
...
impl TryFrom<&super::ValidatorCommittee> for sui_sdk_types::ValidatorCommittee {
    ...
    fn try_from(value: &super::ValidatorCommittee) -> Result<Self, Self::Error> {
        let epoch = value.epoch.ok_or_else(|| TryFromProtoError::missing("epoch"))?;
        Ok(Self { epoch, members: value.members.iter().map(TryInto::try_into).collect::<Result<_, _>>()? })
    }
}
...
impl From<sui_sdk_types::CircomG1> for super::CircomG1 {
    fn from(value: sui_sdk_types::CircomG1) -> Self {
        ...
        Self { e0: Some(e0.to_string()), e1: Some(e1.to_string()), e2: Some(e2.to_string()) }
    }
}
...
impl From<sui_sdk_types::ZkLoginClaim> for super::ZkLoginClaim {
    fn from(sui_sdk_types::ZkLoginClaim { value, index_mod_4 }: sui_sdk_types::ZkLoginClaim) -> Self {
        Self { value: Some(value), index_mod_4: Some(index_mod_4.into()) }
    }
}
...
impl TryFrom<&super::ZkLoginClaim> for sui_sdk_types::ZkLoginClaim {
    ...
    fn try_from(super::ZkLoginClaim { value, index_mod_4 }: &super::ZkLoginClaim) -> Result<Self, Self::Error> {
        let value = value.as_ref().ok_or_else(|| TryFromProtoError::missing("value"))?.into();
        let index_mod_4 = index_mod_4.ok_or_else(|| TryFromProtoError::missing("index_mod_4"))?.try_into()?;
...
impl From<sui_sdk_types::ZkLoginProof> for super::ZkLoginProof {
    fn from(value: sui_sdk_types::ZkLoginProof) -> Self {
        Self { a: Some(value.a.into()), b: Some(value.b.into()), c: Some(value.c.into()) }
    }
}
...
impl TryFrom<&super::ZkLoginProof> for sui_sdk_types::ZkLoginProof {
    ...
    fn try_from(value: &super::ZkLoginProof) -> Result<Self, Self::Error> {
        let a = value.a.as_ref().ok_or_else(|| TryFromProtoError::missing("a"))?.try_into()?;
        let b = value.b.as_ref().ok_or_else(|| TryFromProtoError::missing("b"))?.try_into()?;
        let c = value.c.as_ref().ok_or_else(|| TryFromProtoError::missing("c"))?.try_into()?;
...
impl TryFrom<&super::ZkLoginInputs> for sui_sdk_types::ZkLoginInputs {
    ...
    fn try_from(value: &super::ZkLoginInputs) -> Result<Self, Self::Error> {
        let proof_points =
            value.proof_points.as_ref().ok_or_else(|| TryFromProtoError::missing("proof_points"))?.try_into()?;
        let iss_base64_details = value
            ...
            .try_into()?;
        let header_base64 =
            value.header_base64.as_ref().ok_or_else(|| TryFromProtoError::missing("header_base64"))?.into();
        ...
        Ok(Self { proof_points, iss_base64_details, header_base64, address_seed })
    }
}
...
impl TryFrom<&super::ZkLoginAuthenticator> for sui_sdk_types::ZkLoginAuthenticator {
    ...
    fn try_from(value: &super::ZkLoginAuthenticator) -> Result<Self, Self::Error> {
        let inputs = value.inputs.as_ref().ok_or_else(|| TryFromProtoError::missing("inputs"))?.try_into()?;
        let max_epoch = value.max_epoch.ok_or_else(|| TryFromProtoError::missing("max_epoch"))?;
        let signature =
            value.signature.as_ref().ok_or_else(|| TryFromProtoError::missing("signature"))?.as_ref().try_into()?;

        Ok(Self { inputs, max_epoch, signature })
    }
}
...
impl From<&sui_sdk_types::ZkLoginPublicIdentifier> for super::ZkLoginPublicIdentifier {
    fn from(value: &sui_sdk_types::ZkLoginPublicIdentifier) -> Self {
        Self { iss: Some(value.iss().to_owned()), address_seed: Some(value.address_seed().to_string()) }
    }
}
...
impl TryFrom<&super::ZkLoginPublicIdentifier> for sui_sdk_types::ZkLoginPublicIdentifier {
    ...
    fn try_from(value: &super::ZkLoginPublicIdentifier) -> Result<Self, Self::Error> {
        let iss = value.iss.as_ref().ok_or_else(|| TryFromProtoError::missing("iss"))?.into();
        let address_seed = value
            .address_seed
            .as_ref()
            .ok_or_else(|| TryFromProtoError::missing("address_seed"))?
        ...
        Self::new(iss, address_seed).ok_or_else(|| TryFromProtoError::from_error("invalid iss"))?.pipe(Ok)
    }
}
...
impl MessageMerge<sui_sdk_types::SimpleSignature> for super::UserSignature {
    fn merge(&mut self, source: sui_sdk_types::SimpleSignature, mask: &crate::field_mask::FieldMaskTree) {
        let scheme: super::SignatureScheme = source.scheme().into();
        let (signature, public_key) = match &source {
            sui_sdk_types::SimpleSignature::Ed25519 { signature, public_key } => {
                (signature.as_bytes(), public_key.as_bytes())
            }
            sui_sdk_types::SimpleSignature::Secp256k1 { signature, public_key } => {
                (signature.as_bytes(), public_key.as_bytes())
            }
            sui_sdk_types::SimpleSignature::Secp256r1 { signature, public_key } => {
                (signature.as_bytes(), public_key.as_bytes())
            }
        };
...
impl TryFrom<&super::UserSignature> for sui_sdk_types::SimpleSignature {
    ...
    fn try_from(value: &super::UserSignature) -> Result<Self, Self::Error> {
        ...
        let signature = value.signature.as_ref().ok_or_else(|| TryFromProtoError::missing("signature"))?;
        let public_key = value.public_key.as_ref().ok_or_else(|| TryFromProtoError::missing("public_key"))?;
        let scheme = value
            .scheme
        ...
        match scheme {
            ...
            | SignatureScheme::Passkey => {
                return Err(TryFromProtoError::from_error("invalid or unknown signature scheme"))
            }
        }
        .pipe(Ok)
    }
...
impl TryFrom<&super::PasskeyAuthenticator> for sui_sdk_types::PasskeyAuthenticator {
    ...
    fn try_from(value: &super::PasskeyAuthenticator) -> Result<Self, Self::Error> {
        let authenticator_data =
            value.authenticator_data.as_ref().ok_or_else(|| TryFromProtoError::missing("authenticator_data"))?.to_vec();
        let client_data_json =
            value.client_data_json.as_ref().ok_or_else(|| TryFromProtoError::missing("client_data_json"))?.into();
...
impl TryFrom<&super::MultisigMemberPublicKey> for sui_sdk_types::MultisigMemberPublicKey {
    ...
    fn try_from(value: &super::MultisigMemberPublicKey) -> Result<Self, Self::Error> {
        ...
        match value.scheme() {
            SignatureScheme::Ed25519 => Self::Ed25519(Ed25519PublicKey::from_bytes(value.public_key())?),
            SignatureScheme::Secp256k1 => Self::Secp256k1(Secp256k1PublicKey::from_bytes(value.public_key())?),
            SignatureScheme::Secp256r1 => Self::Secp256r1(Secp256r1PublicKey::from_bytes(value.public_key())?),
            SignatureScheme::Zklogin => {
                Self::ZkLogin(value.zklogin.as_ref().ok_or_else(|| TryFromProtoError::missing("zklogin"))?.try_into()?)
            }
            SignatureScheme::Passkey => {
                Self::Passkey(PasskeyPublicKey::new(Secp256r1PublicKey::from_bytes(value.public_key())?))
            }
            SignatureScheme::Multisig | SignatureScheme::Bls12381 => {
                return Err(TryFromProtoError::from_error("invalid MultisigMemberPublicKey scheme"))
            }
        }
        .pipe(Ok)
    }
...
impl TryFrom<&super::MultisigMember> for sui_sdk_types::MultisigMember {
    ...
    fn try_from(value: &super::MultisigMember) -> Result<Self, Self::Error> {
        let public_key =
            value.public_key.as_ref().ok_or_else(|| TryFromProtoError::missing("public_key"))?.try_into()?;
        let weight = value.weight.ok_or_else(|| TryFromProtoError::missing("weight"))?.try_into()?;
...
impl From<&sui_sdk_types::MultisigCommittee> for super::MultisigCommittee {
    fn from(value: &sui_sdk_types::MultisigCommittee) -> Self {
        Self { members: value.members().iter().map(Into::into).collect(), threshold: Some(value.threshold().into()) }
    }
}
...
impl TryFrom<&super::MultisigCommittee> for sui_sdk_types::MultisigCommittee {
    ...
    fn try_from(value: &super::MultisigCommittee) -> Result<Self, Self::Error> {
        ...
        let threshold = value.threshold.ok_or_else(|| TryFromProtoError::missing("threshold"))?.try_into()?;
...
impl TryFrom<&super::MultisigMemberSignature> for sui_sdk_types::MultisigMemberSignature {
    ...
    fn try_from(value: &super::MultisigMemberSignature) -> Result<Self, Self::Error> {
        ...
        match value.scheme() {
            SignatureScheme::Ed25519 => Self::Ed25519(Ed25519Signature::from_bytes(value.signature())?),
            SignatureScheme::Secp256k1 => Self::Secp256k1(Secp256k1Signature::from_bytes(value.signature())?),
            SignatureScheme::Secp256r1 => Self::Secp256r1(Secp256r1Signature::from_bytes(value.signature())?),
            SignatureScheme::Zklogin => Self::ZkLogin(Box::new(
                value.zklogin.as_ref().ok_or_else(|| TryFromProtoError::missing("zklogin"))?.try_into()?,
            )),
            SignatureScheme::Passkey => {
                Self::Passkey(value.passkey.as_ref().ok_or_else(|| TryFromProtoError::missing("passkey"))?.try_into()?)
            }
            SignatureScheme::Multisig | SignatureScheme::Bls12381 => {
                return Err(TryFromProtoError::from_error("invalid MultisigMemberSignature scheme"))
            }
        }
        .pipe(Ok)
    }
...
impl From<&sui_sdk_types::MultisigAggregatedSignature> for super::MultisigAggregatedSignature {
    fn from(value: &sui_sdk_types::MultisigAggregatedSignature) -> Self {
        Self {
            ...
            legacy_bitmap: value.legacy_bitmap().map(|roaring| roaring.iter().collect()).unwrap_or_default(),
...
impl TryFrom<&super::MultisigAggregatedSignature> for sui_sdk_types::MultisigAggregatedSignature {
    ...
    fn try_from(value: &super::MultisigAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        let bitmap = value.bitmap.ok_or_else(|| TryFromProtoError::missing("bitmap"))?.try_into()?;
        let committee = value.committee.as_ref().ok_or_else(|| TryFromProtoError::missing("committee"))?.try_into()?;

        let mut signature = Self::new(committee, signatures, bitmap);

        if !value.legacy_bitmap.is_empty() {
            let legacy_bitmap = value.legacy_bitmap.iter().copied().collect::<roaring::RoaringBitmap>();
...
impl MessageMerge<sui_sdk_types::UserSignature> for super::UserSignature {
    fn merge(&mut self, source: sui_sdk_types::UserSignature, mask: &crate::field_mask::FieldMaskTree) {
        use sui_sdk_types::UserSignature::*;

        if mask.contains(Self::BCS_FIELD.name) {
            self.bcs =
                Some(super::Bcs { name: Some("UserSignatureBytes".to_owned()), value: Some(source.to_bytes().into()) });
        }
...
impl MessageMerge<&super::UserSignature> for super::UserSignature {
    fn merge(&mut self, source: &super::UserSignature, mask: &crate::field_mask::FieldMaskTree) {
        let super::UserSignature { bcs, scheme, signature, public_key, multisig, zklogin, passkey } = source;
    ...
    fn try_from(value: &super::UserSignature) -> Result<Self, Self::Error> {
        ...
        match scheme {
            ...
            SignatureScheme::Multisig => Self::Multisig(
                value.multisig.as_ref().ok_or_else(|| TryFromProtoError::missing("multisig"))?.try_into()?,
            ),
            SignatureScheme::Zklogin => Self::ZkLogin(Box::new(
                value.zklogin.as_deref().ok_or_else(|| TryFromProtoError::missing("zklogin"))?.try_into()?,
            )),
            SignatureScheme::Passkey => {
                Self::Passkey(value.passkey.as_deref().ok_or_else(|| TryFromProtoError::missing("passkey"))?.try_into()?)
            }
            SignatureScheme::Bls12381 => {
                return Err(TryFromProtoError::from_error("invalid or unknown signature scheme"))
            }
