...
impl Object {
    pub const BCS_FIELD: &'static MessageField = &MessageField::new("bcs").with_message_fields(super::Bcs::FIELDS);
    ...
    pub const HAS_PUBLIC_TRANSFER_FIELD: &'static MessageField = &MessageField::new("has_public_transfer");
    ...
    pub const PREVIOUS_TRANSACTION_FIELD: &'static MessageField = &MessageField::new("previous_transaction");
    pub const STORAGE_REBATE_FIELD: &'static MessageField = &MessageField::new("storage_rebate");
    pub const TYPE_ORIGIN_TABLE_FIELD: &'static MessageField = &MessageField::new("type_origin_table");
...
impl MessageMerge<&sui_sdk_types::MoveStruct> for Object {
    fn merge(&mut self, source: &sui_sdk_types::MoveStruct, mask: &crate::field_mask::FieldMaskTree) {
        if mask.contains(Self::OBJECT_TYPE_FIELD.name) {
...
impl MessageMerge<&sui_sdk_types::MovePackage> for Object {
    fn merge(&mut self, source: &sui_sdk_types::MovePackage, mask: &crate::field_mask::FieldMaskTree) {
        if mask.contains(Self::OBJECT_TYPE_FIELD.name) {
        ...
        if mask.contains(Self::TYPE_ORIGIN_TABLE_FIELD.name) {
            self.type_origin_table = source.type_origin_table.clone().into_iter().map(Into::into).collect();
        }
...
fn try_extract_struct(value: &Object) -> Result<sui_sdk_types::MoveStruct, TryFromProtoError> {
    ...
    let object_type = value.object_type().parse().map_err(TryFromProtoError::from_error)?;

    let has_public_transfer =
        value.has_public_transfer.ok_or_else(|| TryFromProtoError::missing("has_public_transfer"))?;
    let contents = value.contents.as_ref().ok_or_else(|| TryFromProtoError::missing("contents"))?.value().to_vec();
...
fn try_extract_package(value: &Object) -> Result<sui_sdk_types::MovePackage, TryFromProtoError> {
    ...
    let modules = value
        ...
        .map(|module| {
            ...
            let contents = module.contents.as_ref().ok_or_else(|| TryFromProtoError::missing("contents"))?.to_vec();

            Ok((name, contents))
        })
        .collect::<Result<_, TryFromProtoError>>()?;

    let type_origin_table = value.type_origin_table.iter().map(TryInto::try_into).collect::<Result<_, _>>()?;
    ...
    Ok(sui_sdk_types::MovePackage { id, version, modules, type_origin_table, linkage_table })
}
...
impl TryFrom<&Object> for sui_sdk_types::Object {
    ...
    fn try_from(value: &Object) -> Result<Self, Self::Error> {
        ...
        let previous_transaction = value
            ...
            .parse()
            .map_err(TryFromProtoError::from_error)?;
        let storage_rebate = value.storage_rebate.ok_or_else(|| TryFromProtoError::missing("storage_rebate"))?;
        ...
        Ok(Self::new(object_data, owner, previous_transaction, storage_rebate))
    }
}
...
impl TryFrom<&super::TypeOrigin> for sui_sdk_types::TypeOrigin {
    ...
    fn try_from(value: &super::TypeOrigin) -> Result<Self, Self::Error> {
        ...
        Ok(Self { module_name, struct_name, package })
    }
}
...
impl From<sui_sdk_types::GenesisObject> for Object {
    fn from(value: sui_sdk_types::GenesisObject) -> Self {
        ...
        match value.data() {
            sui_sdk_types::ObjectData::Struct(move_struct) => {
                message.merge(move_struct, &crate::field_mask::FieldMaskTree::new_wildcard());
            }
            sui_sdk_types::ObjectData::Package(move_package) => {
                message.merge(move_package, &crate::field_mask::FieldMaskTree::new_wildcard());
            }
        }
...
impl From<sui_sdk_types::ObjectReference> for super::ObjectReference {
    fn from(value: sui_sdk_types::ObjectReference) -> Self {
        ...
        Self { object_id: Some(object_id.to_string()), version: Some(version), digest: Some(digest.to_string()) }
    }
}
...
impl From<sui_sdk_types::Owner> for super::Owner {
    fn from(value: sui_sdk_types::Owner) -> Self {
        ...
        let kind = match value {
            ...
            ConsensusAddress { start_version, owner } => {
...
impl TryFrom<&super::Owner> for sui_sdk_types::Owner {
    ...
    fn try_from(value: &super::Owner) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            OwnerKind::Address => Self::Address(value.address().parse().map_err(TryFromProtoError::from_error)?),
            OwnerKind::Object => Self::Object(value.address().parse().map_err(TryFromProtoError::from_error)?),
            ...
            OwnerKind::ConsensusAddress => Self::ConsensusAddress {
                ...
                owner: value.address().parse().map_err(TryFromProtoError::from_error)?,
            },
        }
        .pipe(Ok)
    }
