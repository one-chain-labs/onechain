...
impl RpcService {
    ...
    pub async fn into_router(self) -> axum::Router {
        ...
        let router = {
            let ledger_service =
                crate::proto::rpc::v2beta::ledger_service_server::LedgerServiceServer::new(self.clone());
            let transaction_execution_service =
                crate::proto::rpc::v2beta::transaction_execution_service_server::TransactionExecutionServiceServer::new(
                    self.clone(),
                );
            let live_data_service =
                crate::proto::rpc::v2alpha::live_data_service_server::LiveDataServiceServer::new(self.clone());
            ...
            let reflection_v1 = tonic_reflection::server::Builder::configure()
                ...
                .register_encoded_file_descriptor_set(crate::proto::rpc::v2beta::FILE_DESCRIPTOR_SET)
                .register_encoded_file_descriptor_set(crate::proto::rpc::v2alpha::FILE_DESCRIPTOR_SET)
            ...
            if let Some(subscription_service_handle) = self.subscription_service_handle.clone() {
                let subscription_service =
                    crate::proto::rpc::v2alpha::subscription_service_server::SubscriptionServiceServer::new(
