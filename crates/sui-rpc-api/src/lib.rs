...
impl RpcService {
    ...
    pub async fn into_router(self) -> axum::Router {
        ...
        let router = {
            let node_service = crate::proto::node::v2::node_service_server::NodeServiceServer::new(self.clone());
            let node_service_alpha =
                crate::proto::node::v2alpha::node_service_server::NodeServiceServer::new(self.clone());
            ...
            let reflection_v1 = tonic_reflection::server::Builder::configure()
                ...
                .register_encoded_file_descriptor_set(crate::proto::node::v2alpha::FILE_DESCRIPTOR_SET)
            ...
            if let Some(subscription_service_handle) = self.subscription_service_handle.clone() {
                services = services.add_service(SubscriptionServiceServer::new(subscription_service_handle));
            }
