...
pub use error::{CheckpointNotFoundError, ErrorDetails, ErrorReason, ObjectNotFoundError, Result, RpcError};
...
impl RpcService {
    ...
    pub fn with_subscription_service(&mut self, subscription_service_handle: SubscriptionServiceHandle) {
    ...
    pub async fn into_router(self) -> axum::Router {
        ...
        let router = {
            let ledger_service =
                sui_rpc::proto::sui::rpc::v2::ledger_service_server::LedgerServiceServer::new(self.clone())
            ...
            let transaction_execution_service = sui_rpc::proto::sui::rpc::v2::transaction_execution_service_server::TransactionExecutionServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let state_service =
                sui_rpc::proto::sui::rpc::v2::state_service_server::StateServiceServer::new(self.clone())
                    .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let signature_verification_service = sui_rpc::proto::sui::rpc::v2::signature_verification_service_server::SignatureVerificationServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let move_package_service =
                sui_rpc::proto::sui::rpc::v2::move_package_service_server::MovePackageServiceServer::new(self.clone())
                    .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let name_service = sui_rpc::proto::sui::rpc::v2::name_service_server::NameServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);

            let event_service_alpha =
                crate::grpc::alpha::event_service_proto::event_service_server::EventServiceServer::new(self.clone());
            ...
            let reflection_v1 = tonic_reflection::server::Builder::configure()
                .register_encoded_file_descriptor_set(crate::proto::google::protobuf::FILE_DESCRIPTOR_SET)
                .register_encoded_file_descriptor_set(crate::proto::google::rpc::FILE_DESCRIPTOR_SET)
            ...
            if self.subscription_service_handle.is_some() {
                let subscription_service =
                    sui_rpc::proto::sui::rpc::v2::subscription_service_server::SubscriptionServiceServer::new(
                        self.clone(),
                    );
                health_reporter
                    .set_service_status(service_name(&subscription_service), tonic_health::ServingStatus::Serving)
                    .await;
        ...
        let health_endpoint =
            axum::Router::new().route("/health", axum::routing::get(service::health::health)).with_state(self.clone());
