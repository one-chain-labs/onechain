...
impl RpcService {
    ...
    pub async fn into_router(self) -> axum::Router {
        ...
        let router = {
            ...
            let ledger_service2 =
                sui_rpc::proto::sui::rpc::v2beta2::ledger_service_server::LedgerServiceServer::new(self.clone());
            ...
            let live_data_service2 =
                sui_rpc::proto::sui::rpc::v2beta2::live_data_service_server::LiveDataServiceServer::new(self.clone())
                    .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            ...
            let move_package_service2 =
                sui_rpc::proto::sui::rpc::v2beta2::move_package_service_server::MovePackageServiceServer::new(
                    self.clone(),
                );
            ...
            if let Some(subscription_service_handle) = self.subscription_service_handle.clone() {
                ...
                let subscription_service2 =
                    sui_rpc::proto::sui::rpc::v2beta2::subscription_service_server::SubscriptionServiceServer::new(
                        subscription_service_handle,
                    );
                health_reporter
                    .set_service_status(service_name(&subscription_service2), tonic_health::ServingStatus::Serving)
                    .await;
