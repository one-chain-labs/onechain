...
use super::{FieldMaskTree, FIELD_PATH_SEPARATOR, FIELD_SEPARATOR};
    ...
    fn test_validate() {
        ...
        impl MessageFields for Foo {
            const FIELDS: &'static [&'static MessageField] =
                &[&MessageField::new("bar").with_message_fields(Bar::FIELDS), &MessageField::new("baz")];
        }
        struct Bar;

        impl MessageFields for Bar {
            const FIELDS: &'static [&'static MessageField] =
                &[&MessageField { name: "a", message_fields: None }, &MessageField { name: "b", message_fields: None }];
        }
