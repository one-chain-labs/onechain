...
impl StateReader {
    ...
    #[tracing::instrument(skip(self))]
    pub fn get_object_with_version(&self, object_id: Address, version: Version) -> crate::Result<Option<Object>> {
        self.inner
    ...
    #[tracing::instrument(skip(self))]
    pub fn get_transaction_read(&self, digest: sui_sdk_types::Digest) -> crate::Result<TransactionRead> {
        ...
        let unchanged_loaded_runtime_objects = self.inner().get_unchanged_loaded_runtime_objects(&(digest.into()));
