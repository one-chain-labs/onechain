...
mod tests {
    ...
    use crate::handlers::{transaction_bcs_handler::TransactionBCSHandler, AnalyticsHandler};
    ...
    pub async fn test_transaction_bcs_handler() -> anyhow::Result<()> {
        ...
        assert_eq!(db_txn.bcs, Base64::encode(bcs::to_bytes(&transaction.transaction_data()).unwrap()));
