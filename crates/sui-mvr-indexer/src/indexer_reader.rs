...
use crate::{
    ...
    schema::{checkpoints, display, epochs, events, objects, pruner_cp_watermark, transactions, tx_digests},
...
impl sui_types::storage::ObjectStore for ConnectionAsObjectStore {
    fn get_object(&self, object_id: &ObjectID) -> Option<sui_types::object::Object> {
        self.get_object(object_id, None).expect("Error getting object")
    }
    ...
    fn get_object_by_key(
        ...
        self.get_object(object_id, Some(version)).expect("Error getting object by key")
    }
}
