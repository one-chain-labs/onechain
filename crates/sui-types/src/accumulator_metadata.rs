...
impl AccumulatorOwner {
    ...
    pub fn exists(
        ...
        DynamicFieldKey(SUI_ACCUMULATOR_ROOT_OBJECT_ID, key, OwnerKey::get_type_tag())
    ...
    pub fn metadata_exists(
        ...
        DynamicFieldKey(*self.balances.id.object_id(), key, MetadataKey::get_type_tag(std::slice::from_ref(type_)))
            .into_id_with_bound(version_bound.unwrap_or(SequenceNumber::MAX))?
            .exists(child_object_resolver)
    }
