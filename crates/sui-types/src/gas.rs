...
pub mod checked {
    ...
    use crate::{
        ...
        gas::GasUsageReport,
        gas_model::{
            gas_predicates::check_for_gas_price_too_high,
            gas_v2::SuiGasStatus as SuiGasStatusV2,
            tables::GasStatus,
        },
        object::Object,
    ...
    impl SuiGasStatus {
        pub fn new(
            ...
            if check_for_gas_price_too_high(config.gas_model_version()) && gas_price >= config.max_gas_price() {
