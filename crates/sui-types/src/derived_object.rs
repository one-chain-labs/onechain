...
pub fn derive_object_id<T>(parent: T, key_type_tag: &TypeTag, key_bytes: &[u8]) -> Result<ObjectID, bcs::Error>
where
    T: Into<SuiAddress>,
{
...
mod tests {
    ...
    fn test_derive_object_snapshot() {
        ...
        let id = derive_object_id(ObjectID::from_str("0x2").unwrap(), &key_type_tag, &key_bytes).unwrap();

        assert_eq!(
            id,
            ObjectID::from_str("0xa2b411aa9588c398d8e3bc97dddbdd430b5ded7f81545d05e33916c3ca0f30c3").unwrap()
        );
    }
    ...
    fn test_derive_object_with_struct_key_snapshot() {
        ...
        assert_eq!(
            id,
            ObjectID::from_str("0x20c58d8790a5d2214c159c23f18a5fdc347211e511186353e785ad543abcea6b").unwrap()
        );
    }
    ...
    fn test_derive_object_with_generic_struct_key_snapshot() {
        ...
        assert_eq!(
            id,
            ObjectID::from_str("0xb497b8dcf1e297ae5fa69c040e4a08ef8240d5373bbc9d6b686ffbd7dfe04cbe").unwrap()
        );
    }
}
