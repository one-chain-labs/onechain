...
pub enum PTBCommandInfo {
    MoveCall { pkg: String, module: String, function: String },
...
pub enum ExtMoveValue {
    Single { name: String, info: ExtMoveValueInfo },
    Vector { name: String, type_: TypeTagWithRefs, value: Vec<SerializableMoveValue> },
}
