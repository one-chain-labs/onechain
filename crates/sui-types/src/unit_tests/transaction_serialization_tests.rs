...
fn test_shared_object_backward_compatibility() {
    ...
    let old_immutable = OldObjectArg::SharedObject { id: test_id, initial_shared_version: test_version, mutable: false };
    ...
    let old_mutable = OldObjectArg::SharedObject { id: test_id, initial_shared_version: test_version, mutable: true };
