...
bcs_convert_impl!(crate::messages_checkpoint::CheckpointSummary, CheckpointSummary);
bcs_convert_impl!(crate::messages_checkpoint::CertifiedCheckpointSummary, SignedCheckpointSummary);
bcs_convert_impl!(crate::messages_checkpoint::CheckpointContents, CheckpointContents);
bcs_convert_impl!(crate::full_checkpoint_content::CheckpointData, CheckpointData);
bcs_convert_impl!(crate::signature::GenericSignature, UserSignature);
bcs_convert_impl!(crate::crypto::ZkLoginPublicIdentifier, ZkLoginPublicIdentifier);
bcs_convert_impl!(crate::crypto::ZkLoginAuthenticatorAsBytes, ZkLoginAuthenticator);
bcs_convert_impl!(crate::zk_login_authenticator::ZkLoginAuthenticator, ZkLoginAuthenticator);
bcs_convert_impl!(crate::crypto::PasskeyAuthenticatorAsBytes, PasskeyAuthenticator);
bcs_convert_impl!(crate::passkey_authenticator::PasskeyAuthenticator, PasskeyAuthenticator);
...
impl<const T: bool> From<crate::crypto::AuthorityQuorumSignInfo<T>> for ValidatorAggregatedSignature {
    fn from(value: crate::crypto::AuthorityQuorumSignInfo<T>) -> Self {
        let crate::crypto::AuthorityQuorumSignInfo { epoch, signature, signers_map } = value;
...
impl<const T: bool> From<ValidatorAggregatedSignature> for crate::crypto::AuthorityQuorumSignInfo<T> {
...
impl From<crate::object::Owner> for Owner {
    fn from(value: crate::object::Owner) -> Self {
        match value {
            ...
            crate::object::Owner::Shared { initial_shared_version } => Self::Shared(initial_shared_version.value()),
            crate::object::Owner::Immutable => Self::Immutable,
            crate::object::Owner::ConsensusAddressOwner { start_version, owner } => {
                Self::ConsensusAddress { start_version: start_version.value(), owner: owner.into() }
            }
        }
    }
}
    ...
    fn from(value: Owner) -> Self {
        match value {
            ...
            Owner::Shared(initial_shared_version) => {
                crate::object::Owner::Shared { initial_shared_version: initial_shared_version.into() }
            }
            Owner::Immutable => crate::object::Owner::Immutable,
            Owner::ConsensusAddress { start_version, owner } => {
                crate::object::Owner::ConsensusAddressOwner { start_version: start_version.into(), owner: owner.into() }
            }
...
impl TryFrom<crate::transaction::SenderSignedData> for SignedTransaction {
    ...
    fn try_from(value: crate::transaction::SenderSignedData) -> Result<Self, Self::Error> {
        let crate::transaction::SenderSignedTransaction { intent_message, tx_signatures } = value.into_inner();

        Self {
            transaction: intent_message.value.try_into()?,
            signatures: tx_signatures.into_iter().map(TryInto::try_into).collect::<Result<_, _>>()?,
        }
        .pipe(Ok)
    }
}
...
impl TryFrom<SignedTransaction> for crate::transaction::SenderSignedData {
    ...
    fn try_from(value: SignedTransaction) -> Result<Self, Self::Error> {
        let SignedTransaction { transaction, signatures } = value;

        Self::new(transaction.try_into()?, signatures.into_iter().map(TryInto::try_into).collect::<Result<_, _>>()?)
            .pipe(Ok)
    }
}
...
pub fn struct_tag_core_to_sdk(
    ...
    let move_core_types::language_storage::StructTag { address, module, name, type_params } = value;
...
pub fn type_tag_sdk_to_core(
    ...
    match value {
        ...
        TypeTag::Vector(type_tag) => {
            move_core_types::language_storage::TypeTag::Vector(Box::new(type_tag_sdk_to_core(*type_tag)?))
        }
        TypeTag::Struct(struct_tag) => {
            move_core_types::language_storage::TypeTag::Struct(Box::new(struct_tag_sdk_to_core(*struct_tag)?))
        }
...
pub fn struct_tag_sdk_to_core(
    ...
    let type_params = type_params.iter().cloned().map(type_tag_sdk_to_core).collect::<Result<_, _>>()?;
    move_core_types::language_storage::StructTag { address, module, name, type_params }.pipe(Ok)
}
...
impl TryFrom<crate::type_input::TypeInput> for TypeTag {
    ...
    fn try_from(value: crate::type_input::TypeInput) -> Result<Self, Self::Error> {
        match value {
            ...
            crate::type_input::TypeInput::Vector(type_input) => Self::Vector(Box::new((*type_input).try_into()?)),
            crate::type_input::TypeInput::Struct(struct_input) => Self::Struct(Box::new((*struct_input).try_into()?)),
...
impl TryFrom<crate::type_input::StructInput> for StructTag {
    ...
    fn try_from(value: crate::type_input::StructInput) -> Result<Self, Self::Error> {
        Self::new(
            ...
            value.type_params.into_iter().map(TryInto::try_into).collect::<Result<_, _>>()?,
        )
        .pipe(Ok)
    }
}
...
impl From<StructTag> for crate::type_input::StructInput {
    fn from(value: StructTag) -> Self {
        Self {
            address: move_core_types::account_address::AccountAddress::new(value.address().into_inner()),
            module: value.module().as_str().into(),
            name: value.name().as_str().into(),
            type_params: value.type_params().iter().cloned().map(crate::type_input::TypeInput::from).collect(),
        }
    }
}
    ...
    fn from(value: crate::committee::Committee) -> Self {
        Self {
            ...
            members: value
                .voting_rights
                .into_iter()
                .map(|(name, stake)| ValidatorCommitteeMember { public_key: name.into(), stake })
                .collect(),
        }
    }
}
...
impl From<ValidatorCommittee> for crate::committee::Committee {
    fn from(value: ValidatorCommittee) -> Self {
        ...
        Self::new(epoch, members.into_iter().map(|member| (member.public_key.into(), member.stake)).collect())
    }
}
...
impl From<UnchangedConsensusKind> for crate::effects::UnchangedConsensusKind {
    fn from(value: UnchangedConsensusKind) -> Self {
        match value {
            ...
            UnchangedConsensusKind::MutateDeleted { version } => Self::MutateConsensusStreamEnded(version.into()),
            UnchangedConsensusKind::ReadDeleted { version } => Self::ReadConsensusStreamEnded(version.into()),
    ...
    fn from(value: crate::effects::UnchangedConsensusKind) -> Self {
        match value {
            crate::effects::UnchangedConsensusKind::ReadOnlyRoot((version, digest)) => {
                Self::ReadOnlyRoot { version: version.into(), digest: digest.into() }
            }
            crate::effects::UnchangedConsensusKind::MutateConsensusStreamEnded(version) => {
                Self::MutateDeleted { version: version.into() }
            }
            crate::effects::UnchangedConsensusKind::ReadConsensusStreamEnded(version) => {
                Self::ReadDeleted { version: version.into() }
            }
            crate::effects::UnchangedConsensusKind::Cancelled(version) => Self::Canceled { version: version.into() },
...
impl From<crate::effects::ObjectOut> for ObjectOut {
    fn from(value: crate::effects::ObjectOut) -> Self {
        match value {
            ...
            crate::effects::ObjectOut::PackageWrite((version, digest)) => {
                Self::PackageWrite { version: version.value(), digest: digest.into() }
            }
...
impl From<crate::execution_status::TypeArgumentError> for TypeArgumentError {
    fn from(value: crate::execution_status::TypeArgumentError) -> Self {
        match value {
            ...
            crate::execution_status::TypeArgumentError::ConstraintNotSatisfied => Self::ConstraintNotSatisfied,
        }
    }
}
    ...
    fn from(value: crate::execution_status::PackageUpgradeError) -> Self {
        match value {
            crate::execution_status::PackageUpgradeError::UnableToFetchPackage { package_id } => {
                Self::UnableToFetchPackage { package_id: package_id.into() }
            }
            crate::execution_status::PackageUpgradeError::NotAPackage { object_id } => {
                Self::NotAPackage { object_id: object_id.into() }
            }
            crate::execution_status::PackageUpgradeError::IncompatibleUpgrade => Self::IncompatibleUpgrade,
            crate::execution_status::PackageUpgradeError::DigestDoesNotMatch { digest } => {
                Self::DigestDoesNotMatch { digest: Digest::from_bytes(digest).unwrap() }
            }
            crate::execution_status::PackageUpgradeError::UnknownUpgradePolicy { policy } => {
                Self::UnknownUpgradePolicy { policy }
            }
            crate::execution_status::PackageUpgradeError::PackageIDDoesNotMatch { package_id, ticket_id } => {
                Self::PackageIdDoesNotMatch { package_id: package_id.into(), ticket_id: ticket_id.into() }
            }
        }
    }
}
...
impl From<PackageUpgradeError> for crate::execution_status::PackageUpgradeError {
    fn from(value: PackageUpgradeError) -> Self {
        match value {
            ...
            PackageUpgradeError::NotAPackage { object_id } => Self::NotAPackage { object_id: object_id.into() },
            PackageUpgradeError::IncompatibleUpgrade => Self::IncompatibleUpgrade,
            PackageUpgradeError::DigestDoesNotMatch { digest } => {
                Self::DigestDoesNotMatch { digest: digest.into_inner().to_vec() }
            }
            PackageUpgradeError::UnknownUpgradePolicy { policy } => Self::UnknownUpgradePolicy { policy },
...
impl From<crate::execution_status::CommandArgumentError> for CommandArgumentError {
    fn from(value: crate::execution_status::CommandArgumentError) -> Self {
        match value {
            ...
            crate::execution_status::CommandArgumentError::InvalidArgumentToPrivateEntryFunction => {
                Self::InvalidArgumentToPrivateEntryFunction
            }
            crate::execution_status::CommandArgumentError::IndexOutOfBounds { idx } => {
                Self::IndexOutOfBounds { index: idx }
            }
            crate::execution_status::CommandArgumentError::SecondaryIndexOutOfBounds { result_idx, secondary_idx } => {
                Self::SecondaryIndexOutOfBounds { result: result_idx, subresult: secondary_idx }
            }
            crate::execution_status::CommandArgumentError::InvalidResultArity { result_idx } => {
                Self::InvalidResultArity { result: result_idx }
            }
            ...
            crate::execution_status::CommandArgumentError::SharedObjectOperationNotAllowed => {
            ...
            crate::execution_status::CommandArgumentError::ArgumentWithoutValue => Self::ArgumentWithoutValue,
            crate::execution_status::CommandArgumentError::CannotMoveBorrowedValue => Self::CannotMoveBorrowedValue,
            crate::execution_status::CommandArgumentError::CannotWriteToExtendedReference => {
                Self::CannotWriteToExtendedReference
            }
            crate::execution_status::CommandArgumentError::InvalidReferenceArgument => Self::InvalidReferenceArgument,
        }
    }
}
...
impl From<CommandArgumentError> for crate::execution_status::CommandArgumentError {
    fn from(value: CommandArgumentError) -> Self {
        match value {
            ...
            CommandArgumentError::InvalidArgumentToPrivateEntryFunction => Self::InvalidArgumentToPrivateEntryFunction,
            CommandArgumentError::IndexOutOfBounds { index } => Self::IndexOutOfBounds { idx: index },
            CommandArgumentError::SecondaryIndexOutOfBounds { result, subresult } => {
                Self::SecondaryIndexOutOfBounds { result_idx: result, secondary_idx: subresult }
            }
            CommandArgumentError::InvalidResultArity { result } => Self::InvalidResultArity { result_idx: result },
            ...
            CommandArgumentError::ConsensusObjectOperationNotAllowed => Self::SharedObjectOperationNotAllowed,
            ...
            CommandArgumentError::InvalidMakeMoveVecNonObjectArgument => Self::InvalidMakeMoveVecNonObjectArgument,
            ...
            CommandArgumentError::CannotWriteToExtendedReference => Self::CannotWriteToExtendedReference,
...
impl From<crate::execution_status::ExecutionFailureStatus> for ExecutionError {
    fn from(value: crate::execution_status::ExecutionFailureStatus) -> Self {
        match value {
            ...
            crate::execution_status::ExecutionFailureStatus::MoveObjectTooBig { object_size, max_object_size } => {
                Self::ObjectTooBig { object_size, max_object_size }
            }
            crate::execution_status::ExecutionFailureStatus::MovePackageTooBig { object_size, max_object_size } => {
                Self::PackageTooBig { object_size, max_object_size }
            }
            crate::execution_status::ExecutionFailureStatus::CircularObjectOwnership { object } => {
                Self::CircularObjectOwnership { object: object.into() }
            }
            ...
            crate::execution_status::ExecutionFailureStatus::PublishErrorNonZeroAddress => {
            ...
            crate::execution_status::ExecutionFailureStatus::MovePrimitiveRuntimeError(move_location_opt) => {
                Self::MovePrimitiveRuntimeError { location: move_location_opt.0.map(Into::into) }
            }
            crate::execution_status::ExecutionFailureStatus::MoveAbort(move_location, code) => {
                Self::MoveAbort { location: move_location.into(), code }
            }
            crate::execution_status::ExecutionFailureStatus::VMVerificationOrDeserializationError => {
            ...
            crate::execution_status::ExecutionFailureStatus::CommandArgumentError { arg_idx, kind } => {
                Self::CommandArgumentError { argument: arg_idx, kind: kind.into() }
            }
            crate::execution_status::ExecutionFailureStatus::TypeArgumentError { argument_idx, kind } => {
                Self::TypeArgumentError { type_argument: argument_idx, kind: kind.into() }
            }
            crate::execution_status::ExecutionFailureStatus::UnusedValueWithoutDrop { result_idx, secondary_idx } => {
                Self::UnusedValueWithoutDrop { result: result_idx, subresult: secondary_idx }
            }
            crate::execution_status::ExecutionFailureStatus::InvalidPublicFunctionReturnType { idx } => {
            ...
            crate::execution_status::ExecutionFailureStatus::EffectsTooLarge { current_size, max_size } => {
                Self::EffectsTooLarge { current_size, max_size }
            }
            crate::execution_status::ExecutionFailureStatus::PublishUpgradeMissingDependency => {
                Self::PublishUpgradeMissingDependency
            }
            crate::execution_status::ExecutionFailureStatus::PublishUpgradeDependencyDowngrade => {
                Self::PublishUpgradeDependencyDowngrade
            }
            crate::execution_status::ExecutionFailureStatus::PackageUpgradeError { upgrade_error } => {
                Self::PackageUpgradeError { kind: upgrade_error.into() }
            }
            crate::execution_status::ExecutionFailureStatus::WrittenObjectsTooLarge { current_size, max_size } => {
                Self::WrittenObjectsTooLarge { object_size: current_size, max_object_size: max_size }
            }
            crate::execution_status::ExecutionFailureStatus::CertificateDenied => Self::CertificateDenied,
            crate::execution_status::ExecutionFailureStatus::SuiMoveVerificationTimedout => {
                Self::SuiMoveVerificationTimedout
            }
            crate::execution_status::ExecutionFailureStatus::SharedObjectOperationNotAllowed => {
                Self::ConsensusObjectOperationNotAllowed
            }
            crate::execution_status::ExecutionFailureStatus::InputObjectDeleted => Self::InputObjectDeleted,
            crate::execution_status::ExecutionFailureStatus::ExecutionCancelledDueToSharedObjectCongestion {
                congested_objects,
            ...
            crate::execution_status::ExecutionFailureStatus::AddressDeniedForCoin { address, coin_type } => {
                Self::AddressDeniedForCoin { address: address.into(), coin_type }
            }
            crate::execution_status::ExecutionFailureStatus::CoinTypeGlobalPause { coin_type } => {
                Self::CoinTypeGlobalPause { coin_type }
            }
            crate::execution_status::ExecutionFailureStatus::ExecutionCancelledDueToRandomnessUnavailable => {
                Self::ExecutionCanceledDueToRandomnessUnavailable
            }
            crate::execution_status::ExecutionFailureStatus::MoveVectorElemTooBig { value_size, max_scaled_size } => {
                Self::MoveVectorElemTooBig { value_size, max_scaled_size }
            }
            crate::execution_status::ExecutionFailureStatus::MoveRawValueTooBig { value_size, max_scaled_size } => {
                Self::MoveRawValueTooBig { value_size, max_scaled_size }
            }
...
impl From<ExecutionError> for crate::execution_status::ExecutionFailureStatus {
    fn from(value: ExecutionError) -> Self {
        match value {
            ...
            ExecutionError::ObjectTooBig { object_size, max_object_size } => {
                Self::MoveObjectTooBig { object_size, max_object_size }
            }
            ExecutionError::PackageTooBig { object_size, max_object_size } => {
                Self::MovePackageTooBig { object_size, max_object_size }
            }
            ...
            ExecutionError::MovePrimitiveRuntimeError { location } => {
                Self::MovePrimitiveRuntimeError(crate::execution_status::MoveLocationOpt(location.map(Into::into)))
            }
            ExecutionError::MoveAbort { location, code } => Self::MoveAbort(location.into(), code),
            ExecutionError::VmVerificationOrDeserializationError => Self::VMVerificationOrDeserializationError,
            ...
            ExecutionError::CommandArgumentError { argument, kind } => {
                Self::CommandArgumentError { arg_idx: argument, kind: kind.into() }
            }
            ExecutionError::TypeArgumentError { type_argument, kind } => {
                Self::TypeArgumentError { argument_idx: type_argument, kind: kind.into() }
            }
            ExecutionError::UnusedValueWithoutDrop { result, subresult } => {
                Self::UnusedValueWithoutDrop { result_idx: result, secondary_idx: subresult }
            }
            ...
            ExecutionError::EffectsTooLarge { current_size, max_size } => {
                Self::EffectsTooLarge { current_size, max_size }
            }
            ExecutionError::PublishUpgradeMissingDependency => Self::PublishUpgradeMissingDependency,
            ExecutionError::PublishUpgradeDependencyDowngrade => Self::PublishUpgradeDependencyDowngrade,
            ExecutionError::PackageUpgradeError { kind } => Self::PackageUpgradeError { upgrade_error: kind.into() },
            ExecutionError::WrittenObjectsTooLarge { object_size, max_object_size } => {
                Self::WrittenObjectsTooLarge { current_size: object_size, max_size: max_object_size }
            }
            ...
            ExecutionError::ConsensusObjectOperationNotAllowed => Self::SharedObjectOperationNotAllowed,
            ExecutionError::InputObjectDeleted => Self::InputObjectDeleted,
            ExecutionError::ExecutionCanceledDueToConsensusObjectCongestion { congested_objects } => {
            ...
            ExecutionError::CoinTypeGlobalPause { coin_type } => Self::CoinTypeGlobalPause { coin_type },
            ExecutionError::ExecutionCanceledDueToRandomnessUnavailable => {
                Self::ExecutionCancelledDueToRandomnessUnavailable
            }
            ExecutionError::MoveVectorElemTooBig { value_size, max_scaled_size } => {
                Self::MoveVectorElemTooBig { value_size, max_scaled_size }
            }
            ExecutionError::MoveRawValueTooBig { value_size, max_scaled_size } => {
                Self::MoveRawValueTooBig { value_size, max_scaled_size }
            }
...
impl From<crate::execution_status::MoveLocation> for MoveLocation {
    fn from(value: crate::execution_status::MoveLocation) -> Self {
        Self {
            ...
            function_name: value.function_name.map(|name| Identifier::new(name).unwrap()),
        }
    }
}
    ...
    fn from(value: crate::execution_status::ExecutionStatus) -> Self {
        match value {
            ...
            crate::execution_status::ExecutionStatus::Failure { error, command } => {
                Self::Failure { error: error.into(), command: command.map(|c| c as u64) }
            }
        }
    }
}
...
impl TryFrom<crate::crypto::PublicKey> for MultisigMemberPublicKey {
    ...
    fn try_from(value: crate::crypto::PublicKey) -> Result<Self, Self::Error> {
        match value {
            ...
            crate::crypto::PublicKey::Passkey(p) => Self::Passkey(PasskeyPublicKey::new(Secp256r1PublicKey::new(p.0))),
        }
        .pipe(Ok)
    }
}
...
impl TryFrom<crate::crypto::CompressedSignature> for MultisigMemberSignature {
    ...
    fn try_from(value: crate::crypto::CompressedSignature) -> Result<Self, Self::Error> {
        match value {
            ...
            crate::crypto::CompressedSignature::ZkLogin(z) => Self::ZkLogin(Box::new(z.try_into()?)),
...
impl TryFrom<crate::crypto::Signature> for SimpleSignature {
    ...
    fn try_from(value: crate::crypto::Signature) -> Result<Self, Self::Error> {
        match value {
            ...
            crate::crypto::Signature::Secp256k1SuiSignature(secp256k1_sui_signature) => Self::Secp256k1 {
                signature: Secp256k1Signature::from_bytes(secp256k1_sui_signature.signature_bytes())?,
                public_key: Secp256k1PublicKey::from_bytes(secp256k1_sui_signature.public_key_bytes())?,
            },

            crate::crypto::Signature::Secp256r1SuiSignature(secp256r1_sui_signature) => Self::Secp256r1 {
                signature: Secp256r1Signature::from_bytes(secp256r1_sui_signature.signature_bytes())?,
                public_key: Secp256r1PublicKey::from_bytes(secp256r1_sui_signature.public_key_bytes())?,
            },
        }
        .pipe(Ok)
    }
        ...
        match value {
            ...
            crate::transaction::CallArg::Object(object_arg) => match object_arg {
                crate::transaction::ObjectArg::ImmOrOwnedObject((id, version, digest)) => {
                    Self::ImmutableOrOwned(ObjectReference::new(id.into(), version.value(), digest.into()))
                }
                crate::transaction::ObjectArg::SharedObject { id, initial_shared_version, mutability } => Self::Shared {
                    object_id: id.into(),
                ...
                crate::transaction::ObjectArg::Receiving((id, version, digest)) => {
                    Self::Receiving(ObjectReference::new(id.into(), version.value(), digest.into()))
                }
            },
    ...
    fn from(value: Input) -> Self {
        ...
        match value {
            ...
            Input::ImmutableOrOwned(object_reference) => {
                ...
                Self::Object(ObjectArg::ImmOrOwnedObject((id.into(), version.into(), digest.into())))
            }
            Input::Shared { object_id, initial_shared_version, mutable } => Self::Object(ObjectArg::SharedObject {
                id: object_id.into(),
            ...
            Input::Receiving(object_reference) => {
                let (id, version, digest) = object_reference.into_parts();
                Self::Object(ObjectArg::Receiving((id.into(), version.into(), digest.into())))
            }
            _ => unreachable!("sdk shouldn't have a variant that the mono repo doesn't"),
        }
    }
...
impl From<crate::transaction::Argument> for Argument {
    fn from(value: crate::transaction::Argument) -> Self {
        match value {
            ...
            crate::transaction::Argument::NestedResult(idx, sub_idx) => Self::NestedResult(idx, sub_idx),
        }
    }
}
...
impl TryFrom<crate::transaction::Command> for Command {
    ...
    fn try_from(value: crate::transaction::Command) -> Result<Self, Self::Error> {
        match value {
            ...
            crate::transaction::Command::TransferObjects(vec, argument) => Self::TransferObjects(TransferObjects {
                objects: vec.into_iter().map(Into::into).collect(),
                address: argument.into(),
            }),
            crate::transaction::Command::SplitCoins(argument, vec) => Self::SplitCoins(SplitCoins {
                coin: argument.into(),
                amounts: vec.into_iter().map(Into::into).collect(),
            }),
            crate::transaction::Command::MergeCoins(argument, vec) => Self::MergeCoins(MergeCoins {
                coin: argument.into(),
                coins_to_merge: vec.into_iter().map(Into::into).collect(),
            }),
            crate::transaction::Command::Publish(vec, vec1) => {
                Self::Publish(Publish { modules: vec, dependencies: vec1.into_iter().map(Into::into).collect() })
            }
            crate::transaction::Command::MakeMoveVec(type_input, elements) => Self::MakeMoveVector(MakeMoveVector {
                type_: type_input.map(TryInto::try_into).transpose()?,
                elements: elements.into_iter().map(Into::into).collect(),
            }),
            crate::transaction::Command::Upgrade(modules, deps, object_id, ticket) => Self::Upgrade(Upgrade {
                modules,
...
impl TryFrom<crate::transaction::ProgrammableMoveCall> for MoveCall {
    ...
    fn try_from(value: crate::transaction::ProgrammableMoveCall) -> Result<Self, Self::Error> {
        Self {
            ...
            type_arguments: value.type_arguments.into_iter().map(TryInto::try_into).collect::<Result<_, _>>()?,
    ...
    fn from(value: Command) -> Self {
        match value {
            ...
            Command::TransferObjects(TransferObjects { objects, address }) => {
                Self::TransferObjects(objects.into_iter().map(Into::into).collect(), address.into())
            }
            Command::SplitCoins(SplitCoins { coin, amounts }) => {
                Self::SplitCoins(coin.into(), amounts.into_iter().map(Into::into).collect())
            }
            Command::MergeCoins(MergeCoins { coin, coins_to_merge }) => {
                Self::MergeCoins(coin.into(), coins_to_merge.into_iter().map(Into::into).collect())
            }
            Command::Publish(Publish { modules, dependencies }) => {
                Self::Publish(modules, dependencies.into_iter().map(Into::into).collect())
            }
            Command::MakeMoveVector(MakeMoveVector { type_, elements }) => {
                Self::MakeMoveVec(type_.map(Into::into), elements.into_iter().map(Into::into).collect())
            }
            Command::Upgrade(Upgrade { modules, dependencies, package, ticket }) => {
                Self::Upgrade(modules, dependencies.into_iter().map(Into::into).collect(), package.into(), ticket.into())
            }
            _ => unreachable!("sdk shouldn't have a variant that the mono repo doesn't"),
        }
    }
    ...
    fn from(value: crate::execution::ExecutionTimeObservationKey) -> Self {
        match value {
            crate::execution::ExecutionTimeObservationKey::MoveEntryPoint {
                ...
                module,
                function,
                type_arguments: type_arguments.into_iter().map(TryInto::try_into).collect::<Result<_, _>>().unwrap(),
            },
...
impl From<crate::transaction::EndOfEpochTransactionKind> for EndOfEpochTransactionKind {
    fn from(value: crate::transaction::EndOfEpochTransactionKind) -> Self {
        match value {
            ...
            crate::transaction::EndOfEpochTransactionKind::AuthenticatorStateCreate => Self::AuthenticatorStateCreate,
            crate::transaction::EndOfEpochTransactionKind::AuthenticatorStateExpire(authenticator_state_expire) => {
                Self::AuthenticatorStateExpire(authenticator_state_expire.into())
            }
            crate::transaction::EndOfEpochTransactionKind::RandomnessStateCreate => Self::RandomnessStateCreate,
            crate::transaction::EndOfEpochTransactionKind::DenyListStateCreate => Self::DenyListStateCreate,
            crate::transaction::EndOfEpochTransactionKind::BridgeStateCreate(chain_identifier) => {
                Self::BridgeStateCreate { chain_id: Digest::new(chain_identifier.as_bytes().to_owned()) }
            }
            crate::transaction::EndOfEpochTransactionKind::BridgeCommitteeInit(sequence_number) => {
                Self::BridgeCommitteeInit { bridge_object_version: sequence_number.value() }
            }
            ...
            crate::transaction::EndOfEpochTransactionKind::CoinRegistryCreate => Self::CoinRegistryCreate,
            crate::transaction::EndOfEpochTransactionKind::DisplayRegistryCreate => Self::DisplayRegistryCreate,
        }
    }
}
...
impl From<crate::transaction::AuthenticatorStateExpire> for AuthenticatorStateExpire {
    fn from(value: crate::transaction::AuthenticatorStateExpire) -> Self {
        Self {
            ...
            authenticator_object_initial_shared_version: value.authenticator_obj_initial_shared_version.value(),
        }
    }
}

impl From<crate::messages_consensus::ConsensusDeterminedVersionAssignments> for ConsensusDeterminedVersionAssignments {
                ...
                canceled_transactions: vec
                    ...
                    .map(|(digest, assignments)| CanceledTransaction {
                        ...
                        version_assignments: assignments
                            .into_iter()
                            .map(|(id, version)| VersionAssignment { object_id: id.into(), version: version.value() })
                            .collect(),
                    })
                    .collect(),
            },
...
impl From<crate::authenticator_state::ActiveJwk> for ActiveJwk {
    fn from(value: crate::authenticator_state::ActiveJwk) -> Self {
        ...
        Self {
            jwk_id: JwkId { iss: jwk_id.iss, kid: jwk_id.kid },
            jwk: Jwk { kty: jwk.kty, e: jwk.e, n: jwk.n, alg: jwk.alg },
            epoch,
        }
    }
}
