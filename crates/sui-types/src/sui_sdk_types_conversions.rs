...
impl<const T: bool> From<crate::crypto::AuthorityQuorumSignInfo<T>> for ValidatorAggregatedSignature {
    fn from(value: crate::crypto::AuthorityQuorumSignInfo<T>) -> Self {
        ...
        Self { epoch, signature: Bls12381Signature::from_bytes(signature.as_ref()).unwrap(), bitmap: signers_map }
    }
}
...
impl From<UnchangedSharedKind> for crate::effects::UnchangedSharedKind {
    fn from(value: UnchangedSharedKind) -> Self {
        match value {
            UnchangedSharedKind::ReadOnlyRoot { version, digest } => Self::ReadOnlyRoot((version.into(), digest.into())),
            UnchangedSharedKind::MutateDeleted { version } => Self::MutateConsensusStreamEnded(version.into()),
            UnchangedSharedKind::ReadDeleted { version } => Self::ReadConsensusStreamEnded(version.into()),
...
impl From<crate::effects::UnchangedSharedKind> for UnchangedSharedKind {
    fn from(value: crate::effects::UnchangedSharedKind) -> Self {
        match value {
            ...
            crate::effects::UnchangedSharedKind::Cancelled(version) => Self::Canceled { version: version.into() },
    ...
    fn from(value: crate::transaction::EndOfEpochTransactionKind) -> Self {
        match value {
            ...
            crate::transaction::EndOfEpochTransactionKind::BridgeStateCreate(chain_identifier) => {
                Self::BridgeStateCreate { chain_id: CheckpointDigest::new(chain_identifier.as_bytes().to_owned()) }
            }
