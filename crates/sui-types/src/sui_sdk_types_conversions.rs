...
pub fn struct_tag_core_to_sdk(
    ...
    StructTag { address, module, name, type_params }.pipe(Ok)
}
...
pub fn struct_tag_sdk_to_core(
    ...
    let StructTag { address, module, name, type_params } = value;
...
impl TryFrom<crate::type_input::StructInput> for StructTag {
    ...
    fn try_from(value: crate::type_input::StructInput) -> Result<Self, Self::Error> {
        Self {
            ...
            type_params: value.type_params.into_iter().map(TryInto::try_into).collect::<Result<_, _>>()?,
        }
        .pipe(Ok)
    }
}
    ...
    fn from(value: crate::transaction::CallArg) -> Self {
        match value {
            ...
            crate::transaction::CallArg::Object(object_arg) => match object_arg {
                ...
                crate::transaction::ObjectArg::SharedObject { id, initial_shared_version, mutable } => Self::Shared {
                    object_id: id.into(),
