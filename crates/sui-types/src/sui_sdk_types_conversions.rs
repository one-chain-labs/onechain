...
impl From<crate::object::Owner> for Owner {
    fn from(value: crate::object::Owner) -> Self {
        match value {
            ...
            crate::object::Owner::ConsensusV2 { start_version: _, authenticator: _ } => todo!(),
        }
    }
}
...
impl From<crate::effects::UnchangedSharedKind> for UnchangedSharedKind {
    fn from(value: crate::effects::UnchangedSharedKind) -> Self {
        match value {
            ...
            crate::effects::UnchangedSharedKind::ReadDeleted(version) => Self::ReadDeleted { version: version.into() },
            crate::effects::UnchangedSharedKind::Cancelled(version) => Self::Cancelled { version: version.into() },
