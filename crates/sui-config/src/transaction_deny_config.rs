...
use crate::dynamic_transaction_signing_checks::{DynamicCheckRunnerContext, DynamicCheckRunnerError};
...
impl TransactionDenyConfigBuilder {
    ...
    pub fn add_dynamic_transaction_checks(mut self, checks: String) -> Result<Self, DynamicCheckRunnerError> {
