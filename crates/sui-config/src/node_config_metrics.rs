...
impl NodeConfigMetrics {
    ...
    pub fn record_metrics(&self, config: &NodeConfig) {
        ...
        self.tx_deny_config_shared_object_disabled.set(config.transaction_deny_config.shared_object_disabled() as i64);
        ...
        self.tx_deny_config_num_denied_objects.set(config.transaction_deny_config.get_object_deny_set().len() as i64);
        self.tx_deny_config_num_denied_packages.set(config.transaction_deny_config.get_package_deny_set().len() as i64);
        self.tx_deny_config_num_denied_addresses.set(config.transaction_deny_config.get_address_deny_set().len() as i64);
    }
}
