...
use sui_types::{
    base_types::{VEC_MAP_ENTRY_STRUCT_NAME, VEC_MAP_MODULE_NAME, VEC_MAP_STRUCT_NAME},
...
impl<'v> AV::Visitor<'v, 'v> for VecMapVisitor<'v, '_> {
    ...
    fn visit_u8(&mut self, _: &AV::ValueDriver<'_, 'v, 'v>, _: u8) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }

    fn visit_u16(&mut self, _: &AV::ValueDriver<'_, 'v, 'v>, _: u16) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }

    fn visit_u32(&mut self, _: &AV::ValueDriver<'_, 'v, 'v>, _: u32) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }

    fn visit_u64(&mut self, _: &AV::ValueDriver<'_, 'v, 'v>, _: u64) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }

    fn visit_u128(&mut self, _: &AV::ValueDriver<'_, 'v, 'v>, _: u128) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }

    fn visit_u256(&mut self, _: &AV::ValueDriver<'_, 'v, 'v>, _: U256) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }

    fn visit_bool(&mut self, _: &AV::ValueDriver<'_, 'v, 'v>, _: bool) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }

    fn visit_address(&mut self, _: &AV::ValueDriver<'_, 'v, 'v>, _: AccountAddress) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }
    ...
    fn visit_variant(&mut self, _: &mut AV::VariantDriver<'_, 'v, 'v>) -> Result<Self::Value, Self::Error> {
        Ok(None)
    }
}
