...
impl MovePackage {
    ...
    pub(crate) async fn object_at(
        ...
        ObjectImpl::from(&self.super_).object_at(ctx, version, root_version, checkpoint).await
    }

    /// The Base64-encoded BCS serialization of this package, as an `Object`.
    pub(crate) async fn object_bcs(&self, ctx: &Context<'_>) -> Result<Option<Base64>, RpcError<object::Error>> {
    ...
    pub(crate) async fn object_versions_after(
        ...
        ObjectImpl::from(&self.super_).object_versions_after(ctx, first, after, last, before, filter).await
    }
    ...
    pub(crate) async fn object_versions_before(
        ...
        ObjectImpl::from(&self.super_).object_versions_before(ctx, first, after, last, before, filter).await
    }
    ...
    async fn package_versions_after(
        ...
        MovePackage::paginate_by_version(ctx, self.super_.super_.scope.clone(), page, self.super_.super_.address, filter)
            .await
    }
    ...
    pub(crate) async fn previous_transaction(
        ...
        ObjectImpl::from(&self.super_).previous_transaction(ctx).await
    }
}
...
impl MovePackage {
    ...
    /// database.
    pub(crate) fn from_stored(scope: Scope, stored: StoredPackage) -> Result<Option<Self>, RpcError<Error>> {
