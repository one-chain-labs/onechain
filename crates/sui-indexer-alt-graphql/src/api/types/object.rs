...
impl Object {
    ...
    pub(crate) async fn as_move_object(&self, ctx: &Context<'_>) -> Result<Option<MoveObject>, RpcError> {
...
impl Object {
    ...
    pub(crate) async fn paginate_live(
        ...
        let refs = match filter {
            ...
            _ => {
                return Err(anyhow!("Invalid ObjectFilter not caught by validation: {filter:?}").into());
            }
        }
        .map_err(|e| match e {
