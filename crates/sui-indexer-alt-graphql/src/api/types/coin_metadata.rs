...
use sui_types::{
    coin::{CoinMetadata as NativeMetadata, TreasuryCap, COIN_METADATA_STRUCT_NAME, COIN_MODULE_NAME},
...
impl CoinMetadata {
    ...
    pub(crate) async fn supply(&self, ctx: &Context<'_>) -> Result<Option<BigInt>, RpcError<object::Error>> {
