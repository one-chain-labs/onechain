...
impl OwnedOrImmutable {
    pub fn from_object_ref(object_id: ObjectID, version: SequenceNumber, digest: ObjectDigest, scope: Scope) -> Self {
...
impl SharedInput {
    pub fn from_shared_object(object_id: ObjectID, initial_shared_version: SequenceNumber, mutable: bool) -> Self {
        Self {
