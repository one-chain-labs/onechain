...
impl FromStr for SuiAddress {
    ...
    fn from_str(s: &str) -> Result<Self, Error> {
        ...
        let hex =
            |i: usize| -> Result<u8, Error> { u8::from_str_radix(&s[i ..= i], 16).map_err(|_| Error::BadHex(i + 2)) };
...
mod tests {
    ...
    const FULL_ADDRESS_STR: &str = "0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef";
    ...
    const FULL_SHORT_ADDRESS_STR: &str = "0x0000000000000000000000000000000000000000000000000000000123456789";
    const SHORT_ADDRESS: SuiAddress = SuiAddress([
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x23, 0x45, 0x67, 0x89,
    ]);
