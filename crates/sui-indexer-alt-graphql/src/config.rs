...
impl Limits {
    ...
    pub(crate) fn pagination(&self) -> PaginationConfig {
        PaginationConfig::new(
            ...
            BTreeMap::from_iter([(("TransactionEffects", "objectChanges"), PageLimits {
...
impl From<HealthConfig> for HealthLayer {
    fn from(value: HealthConfig) -> Self {
        Self { max_checkpoint_lag_ms: Some(value.max_checkpoint_lag.as_millis() as u64), extra: Default::default() }
    }
}
