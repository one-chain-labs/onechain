...
pub fn apply_stream_updates(head: &EventStreamHead, events: Vec<Vec<EventCommitment>>) -> EventStreamHead {
...
mod tests {
    ...
    fn test_compat_with_framework() {
        ...
        assert_eq!(stream_head.mmr, vec![
            U256::from(0u64),
            U256::from(0u64),
            U256::from(0u64),
            U256::from_str("69725770072863840208899320192042305265295220676851872214494910464384102654361").unwrap()
        ]);
    }
