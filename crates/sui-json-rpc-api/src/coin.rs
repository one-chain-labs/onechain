...
use sui_types::{balance::Supply, base_types::SuiAddress};
...
pub trait CoinReadApi {
    ...
    async fn get_coins(
        ...
        owner: SuiAddress,
        /// optional type name for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::one::OCT if not specified.
    ...
    async fn get_balance(
        ...
        /// the owner's Sui address
        owner: SuiAddress,
        /// optional type names for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::one::OCT if not specified.
        coin_type: Option<String>,
    ) -> RpcResult<Balance>;
