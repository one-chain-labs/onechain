...
impl Processor for CoinBalanceBuckets {
    ...
    fn process(&self, checkpoint: &Arc<CheckpointData>) -> Result<Vec<Self::Value>> {
        ...
        self.pruning_lookup_table.insert(cp_sequence_number, prune_info);
...
mod tests {
    ...
    async fn test_process_coin_balance_buckets_new_sui_coin() {
        ...
        assert!(values.iter().any(|v| matches!(v.change, CoinBalanceBucketChangeKind::Insert {
    ...
    async fn test_process_coin_balance_buckets_new_other_coin() {
        ...
        assert_eq!(&values[0].change, &CoinBalanceBucketChangeKind::Insert {
            owner_kind: StoredCoinOwnerKind::Fastpath,
            balance_bucket: 1,
