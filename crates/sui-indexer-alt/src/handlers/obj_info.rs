...
impl TryInto<StoredObjInfo> for &ProcessedObjInfo {
    ...
    fn try_into(self) -> Result<StoredObjInfo> {
        match &self.update {
            ProcessedObjInfoUpdate::Insert(object) => StoredObjInfo::from_object(object, self.cp_sequence_number as i64),
...
mod tests {
    ...
    async fn test_process_basics() {
        ...
        assert!(matches!(processed.update, ProcessedObjInfoUpdate::Insert(_)));
