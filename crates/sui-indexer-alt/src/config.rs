...
impl IndexerConfig {
    ...
    pub fn example() -> Self {
        ...
        example.consistency =
            PrunerLayer { interval_ms: Some(60_000), retention: Some(4 * 60 * 60), ..Default::default() };
    ...
    pub fn for_test() -> Self {
        Self::example().merge(IndexerConfig {
            ingestion: IngestionLayer { retry_interval_ms: Some(10), ingest_concurrency: Some(1), ..Default::default() },
            ...
            consistency: PrunerLayer { interval_ms: Some(50), delay_ms: Some(0), ..Default::default() },
...
mod tests {
    ...
    fn finish_concurrent_unpruned_override() {
        let layer = ConcurrentLayer { committer: None, pruner: None, extra: Default::default() };
