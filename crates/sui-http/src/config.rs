...
impl Config {
    ...
    pub(crate) fn connection_builder(&self) -> hyper_util::server::conn::auto::Builder<hyper_util::rt::TokioExecutor> {
        ...
        let http2_keepalive_timeout =
            self.http2_keepalive_timeout.unwrap_or_else(|| Duration::new(DEFAULT_HTTP2_KEEPALIVE_TIMEOUT_SECS, 0));
