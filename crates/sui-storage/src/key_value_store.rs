...
impl TransactionKeyValueStore {
    ...
    pub async fn multi_get_objects(&self, object_keys: &[ObjectKey]) -> SuiResult<Vec<Option<Object>>> {
...
impl TransactionKeyValueStoreTrait for FallbackTransactionKVStore {
    ...
    async fn multi_get(
        ...
        let secondary_res = self.fallback.multi_get(&fallback_transactions, &fallback_effects).await?;
