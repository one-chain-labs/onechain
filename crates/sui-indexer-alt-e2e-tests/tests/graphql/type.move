...
//# run-graphql
{ # Happy paths
  complex: type(type: "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::oct::OCT>>") { ...Type }
  coin: type(type: "0x2::coin::Coin<0x2::oct::OCT>") { ...Type }
  token: type(type: "0x2::token::Token<0x2::oct::OCT>") { ...Type }
  balance: type(type: "0x2::balance::Balance<0x2::oct::OCT>") { ...Type }
  primitive: type(type: "u64") { ...Type }
  prim_vector: type(type: "vector<u64>") { ...Type }
  coin_vector: type(type: "vector<0x2::coin::Coin<0x2::oct::OCT>>") { ...Type }
}
...
{ # Multi-get
  multiGetTypes(keys: [
    "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::oct::OCT>>",
    "0x2::coin::Coin<0x2::oct::OCT>",
    "0x2::token::Token<0x2::oct::OCT>",
...
{ # Unhappy path, type argument arity mismatch
  type(type: "0x2::coin::Coin<0x2::oct::OCT, u64>") {
    abilities
  }
}
