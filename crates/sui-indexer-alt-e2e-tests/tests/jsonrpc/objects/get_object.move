...
//> 0: sui::table::new<u64, sui::coin::Coin<sui::oct::OCT>>();
...
//> 0: sui::table::add<u64, sui::coin::Coin<sui::oct::OCT>>(Input(0), Input(1), Input(2));
...
//> 0: sui::table::remove<u64, sui::coin::Coin<sui::oct::OCT>>(Input(0), Input(1));
