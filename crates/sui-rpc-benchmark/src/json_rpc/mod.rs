...
pub async fn run_benchmark(endpoint: &str, file_path: &str, concurrency: usize, duration_secs: u64) -> Result<()> {
    ...
    if metrics.total_sent > 0 {
        ...
        let success_rate = ((metrics.total_sent - metrics.total_errors) as f64 / metrics.total_sent as f64) * 100.0;
    ...
    for (method, stats) in methods {
        ...
        if stats.total_sent > 0 {
            ...
            let method_success_rate = ((stats.total_sent - stats.total_errors) as f64 / stats.total_sent as f64) * 100.0;
