...
// gas coin by-ref
//> test::m::heat_imm<one::coin::Coin<one::oct::OCT>>(Gas);
//> test::m::cool(Result(0));
//> test::m::play_coin(Gas);

//# programmable --sender A
// gas coin by-mut
//> test::m::heat_mut<one::coin::Coin<one::oct::OCT>>(Gas);
//> test::m::cool(Result(0));
//> test::m::play_coin(Gas)
...
//> 0: test::m::heat_imm<one::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(Result(0));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0)
// receiving input by-mut
//> 0: test::m::heat_mut<one::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(Result(0));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0)
// receiving input by-val
//> 0: test::m::heat_val<one::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(NestedResult(0,1));
