...
For external types, implement the trait found in [`external_impls.rs`](https://github.com/one-chain-labs/onechain/blob/main/crates/mysten-util-mem/src/external_impls.rs). See the existing implementations in that file for examples.
