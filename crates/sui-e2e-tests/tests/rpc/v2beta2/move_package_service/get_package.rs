...
use sui_rpc::proto::sui::rpc::v2beta2::{move_package_service_client::MovePackageServiceClient, GetPackageRequest};
...
async fn test_get_package_not_found() {
    ...
    let mut request = GetPackageRequest::default();
    request.package_id = Some("0xDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF".to_string());
