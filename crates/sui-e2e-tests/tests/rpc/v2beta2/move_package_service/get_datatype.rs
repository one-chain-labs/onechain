...
use sui_rpc::proto::sui::rpc::v2beta2::{move_package_service_client::MovePackageServiceClient, GetDatatypeRequest};
...
async fn test_get_datatype_not_found() {
    ...
    assert!(error.message().contains("Datatype 'NonExistentType' not found"));
}
