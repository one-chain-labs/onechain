...
use sui_rpc_api::proto::node::v2::{node_service_client::NodeServiceClient, GetNodeInfoRequest, GetNodeInfoResponse};
...
async fn get_node_info() {
    ...
    let GetNodeInfoResponse {
        ...
        software_version,
    } = grpc_client.get_node_info(GetNodeInfoRequest {}).await.unwrap().into_inner();
