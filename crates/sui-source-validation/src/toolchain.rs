...
fn download_and_compile(
    ...
    if !dest_canonical_binary.exists() {
        ...
        let mainnet_url = format!(
            "https://github.com/one-chain-labs/onechain/releases/download/mainnet-v{compiler_version}/sui-mainnet-v{compiler_version}-{platform}.tgz",
        );
        ...
        let mut response = match ureq::get(&mainnet_url).call() {
            ...
            Err(ureq::Error::Status(404, _)) => {
                ...
                let testnet_url = format!("https://github.com/one-chain-labs/onechain/releases/download/testnet-v{compiler_version}/sui-testnet-v{compiler_version}-{platform}.tgz");
