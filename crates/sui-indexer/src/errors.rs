...
impl From<IndexerError> for RpcError {
    fn from(e: IndexerError) -> Self {
        RpcError::owned(jsonrpsee::types::error::CALL_EXECUTION_FAILED_CODE, e.to_string(), None::<()>)
    }
}
...
pub(crate) fn client_error_to_error_object(e: jsonrpsee::core::ClientError) -> jsonrpsee::types::ErrorObjectOwned {
    match e {
