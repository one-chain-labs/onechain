...
use crate::{
    ...
    types::{EventIndex, IndexedCheckpoint, IndexedEvent, IndexedPackage, IndexedTransaction, TxIndex},
};
...
pub trait IndexerStore: Clone + Sync + Send + 'static {
    ...
    async fn persist_event_indices(&self, event_indices: Vec<EventIndex>) -> Result<(), IndexerError>;
