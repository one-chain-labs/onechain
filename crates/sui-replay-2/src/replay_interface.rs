...
pub trait ReadWriteDataStore: ReadDataStore + TransactionStoreWriter + EpochStoreWriter + ObjectStoreWriter {}
...
impl<T> ReadWriteDataStore for T where T: ReadDataStore + TransactionStoreWriter + EpochStoreWriter + ObjectStoreWriter {}
