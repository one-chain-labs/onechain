...
use crate::{
    ingestion::{
        ...
        error::{Error, Result},
        ingestion_client::{IngestionClient, IngestionClientArgs},
        streaming_client::{GrpcStreamingClient, StreamingClientArgs},
    },
...
impl IngestionService {
    ...
    pub fn new(
        ...
        Ok(Self { config, ingestion_client, streaming_client, commit_hi_tx, commit_hi_rx, subscribers, metrics, cancel })
    }
    ...
    pub fn subscribe(&mut self) -> (mpsc::Receiver<Arc<Checkpoint>>, mpsc::UnboundedSender<(&'static str, u64)>) {
