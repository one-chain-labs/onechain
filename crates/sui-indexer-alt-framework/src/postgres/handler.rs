...
//!
//! See: <https://github.com/one-chain-labs/onechain/pull/24055#issuecomment-3471278182>
...
pub trait Handler: Processor<Value: FieldCount> {
    ...
    /// pruning at all.
    async fn prune<'a>(&self, _from: u64, _to_exclusive: u64, _conn: &mut Connection<'a>) -> anyhow::Result<usize> {
        Ok(0)
    }
}
