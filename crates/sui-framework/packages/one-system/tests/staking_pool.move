...
module one_system::staking_pool_tests {
    ...
    fun test_join_fungible_staked_sui_happy() {
        ...
        one::test_utils::destroy(fungible_staked_sui_1);
    ...
    fun test_split_fungible_staked_sui_happy() {
        ...
        one::test_utils::destroy(staking_pool);
        one::test_utils::destroy(fungible_staked_sui_1);
        one::test_utils::destroy(fungible_staked_sui_2);
    ...
    fun test_convert_to_fungible_staked_sui_fail_too_early() {
        ...
        one::test_utils::destroy(staking_pool);
        one::test_utils::destroy(fungible_staked_sui);
    ...
    fun test_redeem_fungible_staked_sui_regression_rounding() {
        ...
        one::test_utils::destroy(staking_pool);
        one::test_utils::destroy(staked_sui_1);
