...
fun process_pending_stake_withdraw_no_underflow_in_safe_mode_1() {
    ...
    runner.system_tx!(|system, _| {
        ...
        assert_eq!(pool.pool_token_balance(), 100 * MIST_PER_OCT);
    });
    ...
    runner.system_tx!(|system, _| {
        ...
        assert_eq!(pool.sui_balance(), 100 * MIST_PER_OCT);
        assert_eq!(pool.pool_token_balance(), 100 * MIST_PER_OCT);
        assert_eq!(pool.pending_stake_amount(), 101 * MIST_PER_OCT);
    });
    ...
    runner.system_tx!(|system, _| {
        ...
        assert_eq!(pool.pool_token_balance(), 100 * MIST_PER_OCT);
        assert_eq!(pool.pending_stake_amount(), 101 * MIST_PER_OCT);
        assert_eq!(pool.pending_stake_withdraw_amount(), 101 * MIST_PER_OCT);
        assert_eq!(pool.pending_pool_token_withdraw_amount(), 101 * MIST_PER_OCT);
    });
    ...
    runner.system_tx!(|system, _| {
        ...
        assert_eq!(pool.pending_stake_amount(), 0 * MIST_PER_OCT);
        assert_eq!(pool.pending_stake_withdraw_amount(), 0 * MIST_PER_OCT);
        assert_eq!(pool.pending_pool_token_withdraw_amount(), 0 * MIST_PER_OCT);
        assert_eq!(pool.sui_balance(), 100 * MIST_PER_OCT);
        assert_eq!(pool.pool_token_balance(), 100 * MIST_PER_OCT);
    });
    ...
    runner.system_tx!(|system, _| {
        ...
        assert_eq!(pool.sui_balance(), 0 * MIST_PER_OCT);
        assert_eq!(pool.pool_token_balance(), 0 * MIST_PER_OCT);
    });
...
fun process_pending_stake_withdraw_no_underflow_in_safe_mode_2() {
    ...
    runner.system_tx!(|system, _| {
        ...
        assert_eq!(pool.sui_balance(), 125 * MIST_PER_OCT);
        assert_eq!(pool.pool_token_balance(), 100 * MIST_PER_OCT);
    });
    ...
    runner.system_tx!(|system, _| {
        ...
        assert_eq!(exchange_rate.sui_amount(), 250 * MIST_PER_OCT);
        ...
        assert_eq!(pool.sui_balance(), 250 * MIST_PER_OCT);
        assert_eq!(pool.pool_token_balance(), 166666666666);
    });

    // staker 1 unstakes
    runner.set_sender(STAKER_ADDR_1).owned_tx!<one_system::staking_pool::StakedOct>(|stake| {
        ...
        runner.system_tx!(|system, ctx| {
            ...
            assert_eq!(pool.pending_pool_token_withdraw_amount(), 80 * MIST_PER_OCT);
            // exchange rate for epoch 5: 1666...6: 250
            // total withdraw: 80 * 250 / 166...6 = 120 sui
            assert_eq!(pool.pending_stake_withdraw_amount(), 120 * MIST_PER_OCT); // 100 principal + 20 rewards
        });
    });
    ...
    runner.system_tx!(|system, _| {
        ...
        assert_eq!(pool.sui_balance(), 155 * MIST_PER_OCT);
        assert_eq!(pool.pending_stake_withdraw_amount(), 155 * MIST_PER_OCT);
        ...
        assert_eq!(pool.pending_stake_withdraw_amount(), 155 * MIST_PER_OCT); // 100 principal + 55 rewards
