...
#[test, expected_failure(abort_code = one::package::ETooPermissive)]
...
#[test, expected_failure(abort_code = one::package::EAlreadyAuthorized)]
...
#[test, expected_failure(abort_code = one::package::EWrongUpgradeCap)]
