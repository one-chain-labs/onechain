...
#[test_only]
module one::funds_accumulator_tests;

use std::unit_test::assert_eq;
use one::funds_accumulator::create_withdrawal;
...
#[random_test]
#[expected_failure(abort_code = one::funds_accumulator::EInvalidSubLimit)]
...
#[test]
#[expected_failure(abort_code = one::funds_accumulator::EOwnerMismatch)]
...
#[random_test]
#[expected_failure(abort_code = one::funds_accumulator::EOverflow)]
