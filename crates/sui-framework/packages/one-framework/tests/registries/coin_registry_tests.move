...
#[test_only]
module one::coin_registry_tests;

use std::string::String;
use std::unit_test::assert_eq;
use one::coin::{Self, DenyCapV2, TreasuryCap, CoinMetadata};
use one::coin_registry::{Self, Currency, CurrencyInitializer, CoinRegistry};
