...
4. Link the move interface with the native function in [all_natives](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-framework/src/natives/mod.rs#L23)
