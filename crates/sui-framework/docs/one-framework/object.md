...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../one-framework/authenticator_state.md#0x2_authenticator_state">authenticator_state</a>(): <a href="../one-framework/object.md#0x2_object_UID">UID</a> {
    <a href="../one-framework/object.md#0x2_object_UID">UID</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="../one-framework/object.md#0x2_object_id_bytes">id_bytes</a>&lt;T: key&gt;(obj: &T): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    <a href="../move-stdlib/bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(&<a href="../one-framework/object.md#0x2_object_borrow_uid">borrow_uid</a>(obj).id)
}
</code></pre>
