...
<pre><code><b>const</b> <a href="../one-framework/table.md#0x2_table_ETableNotEmpty">ETableNotEmpty</a>: u64 = 0;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one-framework/table.md#0x2_table_length">length</a>&lt;K: <b>copy</b>, drop, store, V: store&gt;(<a href="../one-framework/table.md#0x2_table">table</a>: &<a href="../one-framework/table.md#0x2_table_Table">table::Table</a>&lt;K, V&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one-framework/table.md#0x2_table_length">length</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="../one-framework/table.md#0x2_table">table</a>: &<a href="../one-framework/table.md#0x2_table_Table">Table</a>&lt;K, V&gt;): u64 {
