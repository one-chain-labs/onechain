...
<dt>
<code>sequence_nums: <a href="../one-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u8, <a href="../move-stdlib/u64.md#0x1_u64">u64</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>token_transfer_records: <a href="../one-framework/linked_table.md#0x2_linked_table_LinkedTable">linked_table::LinkedTable</a>&lt;<a href="message.md#0xb_message_BridgeMessageKey">message::BridgeMessageKey</a>, <a href="bridge.md#0xb_bridge_BridgeRecord">bridge::BridgeRecord</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_create">create</a>(id: <a href="../one-framework/object.md#0x2_object_UID">object::UID</a>, chain_id: u8, ctx: &<b>mut</b> <a href="../one-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_create">create</a>(id: UID, chain_id: u8, ctx: &<b>mut</b> TxContext) {
    ...
    <b>let</b> bridge_inner = <a href="bridge.md#0xb_bridge_BridgeInner">BridgeInner</a> {
        ...
        chain_id,
        sequence_nums: <a href="../one-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>(),
        ...
        token_transfer_records: <a href="../one-framework/linked_table.md#0x2_linked_table_new">linked_table::new</a>(ctx),
    ...
    <b>let</b> <a href="bridge.md#0xb_bridge">bridge</a> = <a href="bridge.md#0xb_bridge_Bridge">Bridge</a> {
        id,
        inner: <a href="../one-framework/versioned.md#0x2_versioned_create">versioned::create</a>(<a href="bridge.md#0xb_bridge_CURRENT_VERSION">CURRENT_VERSION</a>, bridge_inner, ctx),
    };
    <a href="../one-framework/transfer.md#0x2_transfer_share_object">transfer::share_object</a>(<a href="bridge.md#0xb_bridge">bridge</a>);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bridge.md#0xb_bridge_register_foreign_token">register_foreign_token</a>&lt;T&gt;(<a href="bridge.md#0xb_bridge">bridge</a>: &<b>mut</b> <a href="bridge.md#0xb_bridge_Bridge">bridge::Bridge</a>, tc: <a href="../one-framework/coin.md#0x2_coin_TreasuryCap">coin::TreasuryCap</a>&lt;T&gt;, uc: <a href="../one-framework/package.md#0x2_package_UpgradeCap">package::UpgradeCap</a>, metadata: &<a href="../one-framework/coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bridge.md#0xb_bridge_send_token">send_token</a>&lt;T&gt;(
    ...
    <b>let</b> token_amount = token.<a href="../one-framework/balance.md#0x2_balance">balance</a>().value();
    ...
    <b>let</b> <a href="message.md#0xb_message">message</a> = <a href="message.md#0xb_message_create_token_bridge_message">message::create_token_bridge_message</a>(
        inner.chain_id,
        bridge_seq_num,
        <a href="../one-framework/address.md#0x2_address_to_bytes">address::to_bytes</a>(ctx.sender()),
        target_chain,
        target_address,
        token_id,
        token_amount,
    ...
    // emit <a href="../one-framework/event.md#0x2_event">event</a>
    emit(
        <a href="bridge.md#0xb_bridge_TokenDepositedEvent">TokenDepositedEvent</a> {
            seq_num: bridge_seq_num,
            source_chain: inner.chain_id,
            sender_address: <a href="../one-framework/address.md#0x2_address_to_bytes">address::to_bytes</a>(ctx.sender()),
            target_chain,
            target_address,
            token_type: token_id,
            amount: token_amount,
...
<pre><code><b>public</b> <b>fun</b> <a href="bridge.md#0xb_bridge_claim_and_transfer_token">claim_and_transfer_token</a>&lt;T&gt;(
    ...
    <b>let</b> (token, owner) = <a href="bridge.md#0xb_bridge">bridge</a>.<a href="bridge.md#0xb_bridge_claim_token_internal">claim_token_internal</a>&lt;T&gt;(<a href="../one-framework/clock.md#0x2_clock">clock</a>, source_chain, bridge_seq_num, ctx);
    <b>if</b> (token.is_some()) {
        <a href="../one-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(token.destroy_some(), owner)
    } <b>else</b> {
        token.destroy_none();
    };
}
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_load_inner">load_inner</a>(
    ...
    // TODO: Replace this <b>with</b> a lazy <b>update</b> function when we add a new version of the inner <a href="../one-framework/object.md#0x2_object">object</a>.
...
<pre><code><b>fun</b> <a href="bridge.md#0xb_bridge_claim_token_internal">claim_token_internal</a>&lt;T&gt;(
    ...
    <b>let</b> owner = <a href="../one-framework/address.md#0x2_address_from_bytes">address::from_bytes</a>(token_payload.token_target_address());
    ...
    // Make sure <a href="../one-framework/transfer.md#0x2_transfer">transfer</a> is within limit.
    <b>if</b> (!inner
