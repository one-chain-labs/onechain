---
title: Module `one::protocol_config`
---
...
-  [Function `is_feature_enabled`](#one_protocol_config_is_feature_enabled)
...
<a name="one_protocol_config_is_feature_enabled"></a>
...
<pre><code><b>public</b>(<a href="../one/package.md#one_package">package</a>) <b>fun</b> <a href="../one/protocol_config.md#one_protocol_config_is_feature_enabled">is_feature_enabled</a>(feature_flag_name: vector&lt;u8&gt;): bool
</code></pre>
...
<pre><code><b>public</b>(<a href="../one/package.md#one_package">package</a>) <b>native</b> <b>fun</b> <a href="../one/protocol_config.md#one_protocol_config_is_feature_enabled">is_feature_enabled</a>(feature_flag_name: vector&lt;u8&gt;): bool;
</code></pre>
