...
-  [Function `send_to_account`](#one_balance_send_to_account)
-  [Function `withdraw_from_account`](#one_balance_withdraw_from_account)
...
<pre><code><b>const</b> <a href="../one/balance.md#one_balance_SUI_TYPE_NAME">SUI_TYPE_NAME</a>: vector&lt;u8&gt; = vector[48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 50, 58, 58, 111, 110, 101, 58, 58, 79, 67, 84];
</code></pre>
...
<a name="one_balance_send_to_account"></a>

## Function `send_to_account`



<pre><code><b>fun</b> <a href="../one/balance.md#one_balance_send_to_account">send_to_account</a>&lt;T&gt;(<a href="../one/balance.md#one_balance">balance</a>: <a href="../one/balance.md#one_balance_Balance">one::balance::Balance</a>&lt;T&gt;, recipient: <b>address</b>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../one/balance.md#one_balance_send_to_account">send_to_account</a>&lt;T&gt;(<a href="../one/balance.md#one_balance">balance</a>: <a href="../one/balance.md#one_balance_Balance">Balance</a>&lt;T&gt;, recipient: <b>address</b>) {
    <b>let</b> <a href="../one/balance.md#one_balance_Balance">Balance</a> { <a href="../one/balance.md#one_balance_value">value</a> } = <a href="../one/balance.md#one_balance">balance</a>;
    <b>let</b> <a href="../one/accumulator.md#one_accumulator">accumulator</a> = <a href="../one/accumulator.md#one_accumulator_accumulator_address">one::accumulator::accumulator_address</a>&lt;<a href="../one/balance.md#one_balance_Balance">Balance</a>&lt;T&gt;&gt;(recipient);
    <a href="../one/accumulator.md#one_accumulator_emit_deposit_event">one::accumulator::emit_deposit_event</a>&lt;<a href="../one/balance.md#one_balance_Balance">Balance</a>&lt;T&gt;&gt;(<a href="../one/accumulator.md#one_accumulator">accumulator</a>, recipient, <a href="../one/balance.md#one_balance_value">value</a>);
}
</code></pre>
...
<a name="one_balance_withdraw_from_account"></a>

## Function `withdraw_from_account`



<pre><code><b>fun</b> <a href="../one/balance.md#one_balance_withdraw_from_account">withdraw_from_account</a>&lt;T&gt;(amount: u64, ctx: &<a href="../one/tx_context.md#one_tx_context_TxContext">one::tx_context::TxContext</a>): <a href="../one/balance.md#one_balance_Balance">one::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../one/balance.md#one_balance_withdraw_from_account">withdraw_from_account</a>&lt;T&gt;(amount: u64, ctx: &TxContext): <a href="../one/balance.md#one_balance_Balance">Balance</a>&lt;T&gt; {
    <b>let</b> owner = ctx.sender();
    <b>let</b> <a href="../one/accumulator.md#one_accumulator">accumulator</a> = <a href="../one/accumulator.md#one_accumulator_accumulator_address">one::accumulator::accumulator_address</a>&lt;<a href="../one/balance.md#one_balance_Balance">Balance</a>&lt;T&gt;&gt;(owner);
    <b>let</b> credit = <a href="../one/balance.md#one_balance_Balance">Balance</a> { <a href="../one/balance.md#one_balance_value">value</a>: amount };
    <a href="../one/accumulator.md#one_accumulator_emit_withdraw_event">one::accumulator::emit_withdraw_event</a>&lt;<a href="../one/balance.md#one_balance_Balance">Balance</a>&lt;T&gt;&gt;(<a href="../one/accumulator.md#one_accumulator">accumulator</a>, owner, amount);
    credit
}
</code></pre>
