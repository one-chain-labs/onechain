...
-  [Struct `Receiving`](#one_transfer_Receiving)
...
-  [Function `public_share_object`](#one_transfer_public_share_object)
-  [Function `receive`](#one_transfer_receive)
-  [Function `public_receive`](#one_transfer_public_receive)
...
<a name="one_transfer_Receiving"></a>

## Struct `Receiving`

This represents the ability to <code><a href="../one/transfer.md#one_transfer_receive">receive</a></code> an object of type <code>T</code>.
...
<pre><code><b>public</b> <b>struct</b> <a href="../one/transfer.md#one_transfer_Receiving">Receiving</a>&lt;<b>phantom</b> T: key&gt; <b>has</b> drop
</code></pre>
...
<pre><code><b>const</b> <a href="../one/transfer.md#one_transfer_EBCSSerializationFailure">EBCSSerializationFailure</a>: u64 = 1;
</code></pre>



<a name="one_transfer_EReceivingObjectTypeMismatch"></a>

The object being received is not of the expected type.


<pre><code><b>const</b> <a href="../one/transfer.md#one_transfer_EReceivingObjectTypeMismatch">EReceivingObjectTypeMismatch</a>: u64 = 2;
</code></pre>
...
<a name="one_transfer_ESharedObjectOperationNotSupported"></a>

Shared object operations such as wrapping, freezing, and converting to owned are not allowed.


<pre><code><b>const</b> <a href="../one/transfer.md#one_transfer_ESharedObjectOperationNotSupported">ESharedObjectOperationNotSupported</a>: u64 = 4;
</code></pre>
...
<a name="one_transfer_transfer"></a>
...
that <code>T</code> is an object defined in the module where <code><a href="../one/transfer.md#one_transfer">transfer</a></code> is invoked. Use
<code><a href="../one/transfer.md#one_transfer_public_transfer">public_transfer</a></code> to transfer an object with <code>store</code> outside of its module.


<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer">transfer</a>&lt;T: key&gt;(obj: T, recipient: <b>address</b>)
</code></pre>
...
<a name="one_transfer_public_transfer"></a>
...
NOT YET SUPPORTED. The function will abort with <code><a href="../one/transfer.md#one_transfer_ENotSupported">ENotSupported</a></code> if used on a network,
...
<code><a href="../one/transfer.md#one_transfer">transfer</a></code> and <code><a href="../one/transfer.md#one_transfer_share_object">share_object</a></code>. It is similar to <code><a href="../one/transfer.md#one_transfer">transfer</a></code> in that the object be authenticated
only by the recipient(s), in this case the <code><a href="../one/party.md#one_party">party</a></code>. This means that only the members
...
<a name="one_transfer_freeze_object"></a>
...
mutated.
This function has custom rules performed by the Sui Move bytecode verifier that ensures
that <code>T</code> is an object defined in the module where <code><a href="../one/transfer.md#one_transfer_freeze_object">freeze_object</a></code> is invoked. Use
<code><a href="../one/transfer.md#one_transfer_public_freeze_object">public_freeze_object</a></code> to freeze an object with <code>store</code> outside of its module.


<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_freeze_object">freeze_object</a>&lt;T: key&gt;(obj: T)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_freeze_object">freeze_object</a>&lt;T: key&gt;(obj: T) {
    <a href="../one/transfer.md#one_transfer_freeze_object_impl">freeze_object_impl</a>(obj)
}
</code></pre>
...
<a name="one_transfer_public_freeze_object"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_public_freeze_object">public_freeze_object</a>&lt;T: key, store&gt;(obj: T)
</code></pre>
...
<a name="one_transfer_share_object"></a>
...
Aborts with <code><a href="../one/transfer.md#one_transfer_ESharedNonNewObject">ESharedNonNewObject</a></code> of the object being shared was not created in this
transaction. This restriction may be relaxed in the future.
This function has custom rules performed by the Sui Move bytecode verifier that ensures
that <code>T</code> is an object defined in the module where <code><a href="../one/transfer.md#one_transfer_share_object">share_object</a></code> is invoked. Use
<code><a href="../one/transfer.md#one_transfer_public_share_object">public_share_object</a></code> to share an object with <code>store</code> outside of its module.


<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_share_object">share_object</a>&lt;T: key&gt;(obj: T)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_share_object">share_object</a>&lt;T: key&gt;(obj: T) {
    <a href="../one/transfer.md#one_transfer_share_object_impl">share_object_impl</a>(obj)
}
</code></pre>
...
<a name="one_transfer_public_share_object"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_public_share_object">public_share_object</a>&lt;T: key, store&gt;(obj: T)
</code></pre>
...
<a name="one_transfer_receive"></a>

## Function `receive`

Given mutable (i.e., locked) access to the <code>parent</code> and a <code><a href="../one/transfer.md#one_transfer_Receiving">Receiving</a></code> argument
...
This function has custom rules performed by the Sui Move bytecode verifier that ensures
that <code>T</code> is an object defined in the module where <code><a href="../one/transfer.md#one_transfer_receive">receive</a></code> is invoked. Use
<code><a href="../one/transfer.md#one_transfer_public_receive">public_receive</a></code> to receivne an object with <code>store</code> outside of its module.


<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_receive">receive</a>&lt;T: key&gt;(parent: &<b>mut</b> <a href="../one/object.md#one_object_UID">one::object::UID</a>, to_receive: <a href="../one/transfer.md#one_transfer_Receiving">one::transfer::Receiving</a>&lt;T&gt;): T
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_receive">receive</a>&lt;T: key&gt;(parent: &<b>mut</b> UID, to_receive: <a href="../one/transfer.md#one_transfer_Receiving">Receiving</a>&lt;T&gt;): T {
    <b>let</b> <a href="../one/transfer.md#one_transfer_Receiving">Receiving</a> { id, version } = to_receive;
    <a href="../one/transfer.md#one_transfer_receive_impl">receive_impl</a>(parent.to_address(), id, version)
}
</code></pre>
...
<a name="one_transfer_public_receive"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_public_receive">public_receive</a>&lt;T: key, store&gt;(parent: &<b>mut</b> <a href="../one/object.md#one_object_UID">one::object::UID</a>, to_receive: <a href="../one/transfer.md#one_transfer_Receiving">one::transfer::Receiving</a>&lt;T&gt;): T
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_public_receive">public_receive</a>&lt;T: key + store&gt;(parent: &<b>mut</b> UID, to_receive: <a href="../one/transfer.md#one_transfer_Receiving">Receiving</a>&lt;T&gt;): T {
    <b>let</b> <a href="../one/transfer.md#one_transfer_Receiving">Receiving</a> { id, version } = to_receive;
    <a href="../one/transfer.md#one_transfer_receive_impl">receive_impl</a>(parent.to_address(), id, version)
}
</code></pre>
...
<a name="one_transfer_receiving_object_id"></a>

## Function `receiving_object_id`

Return the object ID that the given <code><a href="../one/transfer.md#one_transfer_Receiving">Receiving</a></code> argument references.


<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_receiving_object_id">receiving_object_id</a>&lt;T: key&gt;(receiving: &<a href="../one/transfer.md#one_transfer_Receiving">one::transfer::Receiving</a>&lt;T&gt;): <a href="../one/object.md#one_object_ID">one::object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_receiving_object_id">receiving_object_id</a>&lt;T: key&gt;(receiving: &<a href="../one/transfer.md#one_transfer_Receiving">Receiving</a>&lt;T&gt;): ID {
    receiving.id
}
</code></pre>
...
<a name="one_transfer_freeze_object_impl"></a>

## Function `freeze_object_impl`



<pre><code><b>public</b>(<a href="../one/package.md#one_package">package</a>) <b>fun</b> <a href="../one/transfer.md#one_transfer_freeze_object_impl">freeze_object_impl</a>&lt;T: key&gt;(obj: T)
</code></pre>
...
<pre><code><b>public</b>(<a href="../one/package.md#one_package">package</a>) <b>native</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_freeze_object_impl">freeze_object_impl</a>&lt;T: key&gt;(obj: T);
</code></pre>
...
<a name="one_transfer_share_object_impl"></a>

## Function `share_object_impl`



<pre><code><b>public</b>(<a href="../one/package.md#one_package">package</a>) <b>fun</b> <a href="../one/transfer.md#one_transfer_share_object_impl">share_object_impl</a>&lt;T: key&gt;(obj: T)
</code></pre>
...
<a name="one_transfer_transfer_impl"></a>

## Function `transfer_impl`



<pre><code><b>public</b>(<a href="../one/package.md#one_package">package</a>) <b>fun</b> <a href="../one/transfer.md#one_transfer_transfer_impl">transfer_impl</a>&lt;T: key&gt;(obj: T, recipient: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b>(<a href="../one/package.md#one_package">package</a>) <b>native</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_transfer_impl">transfer_impl</a>&lt;T: key&gt;(obj: T, recipient: <b>address</b>);
</code></pre>
...
<a name="one_transfer_receive_impl"></a>

## Function `receive_impl`



<pre><code><b>fun</b> <a href="../one/transfer.md#one_transfer_receive_impl">receive_impl</a>&lt;T: key&gt;(parent: <b>address</b>, to_receive: <a href="../one/object.md#one_object_ID">one::object::ID</a>, version: u64): T
</code></pre>
...
<pre><code><b>native</b> <b>fun</b> <a href="../one/transfer.md#one_transfer_receive_impl">receive_impl</a>&lt;T: key&gt;(parent: <b>address</b>, to_receive: ID, version: u64): T;
</code></pre>
