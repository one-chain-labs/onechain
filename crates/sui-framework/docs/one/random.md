...
-  [Function `fill_buffer`](#one_random_fill_buffer)
-  [Function `generate_bytes`](#one_random_generate_bytes)
-  [Function `u256_from_bytes`](#one_random_u256_from_bytes)
...
-  [Function `u128_in_range`](#one_random_u128_in_range)
...
<pre><code><b>fun</b> <a href="../one/random.md#one_random_load_inner_mut">load_inner_mut</a>(self: &<b>mut</b> <a href="../one/random.md#one_random_Random">Random</a>): &<b>mut</b> <a href="../one/random.md#one_random_RandomInner">RandomInner</a> {
    ...
    <b>let</b> inner: &<b>mut</b> <a href="../one/random.md#one_random_RandomInner">RandomInner</a> = <a href="../one/versioned.md#one_versioned_load_value_mut">versioned::load_value_mut</a>(&<b>mut</b> self.inner);
...
<pre><code><b>fun</b> <a href="../one/random.md#one_random_load_inner">load_inner</a>(self: &<a href="../one/random.md#one_random_Random">Random</a>): &<a href="../one/random.md#one_random_RandomInner">RandomInner</a> {
    ...
    // Replace this with a lazy update function when we add a new version of the inner <a href="../one/object.md#one_object">object</a>.
    <b>assert</b>!(version == <a href="../one/random.md#one_random_CURRENT_VERSION">CURRENT_VERSION</a>, <a href="../one/random.md#one_random_EWrongInnerVersion">EWrongInnerVersion</a>);
    <b>let</b> inner: &<a href="../one/random.md#one_random_RandomInner">RandomInner</a> = <a href="../one/versioned.md#one_versioned_load_value">versioned::load_value</a>(&self.inner);
    <b>assert</b>!(inner.version == version, <a href="../one/random.md#one_random_EWrongInnerVersion">EWrongInnerVersion</a>);
    inner
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_new_generator">new_generator</a>(r: &<a href="../one/random.md#one_random_Random">Random</a>, ctx: &<b>mut</b> TxContext): <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a> {
    <b>let</b> inner = <a href="../one/random.md#one_random_load_inner">load_inner</a>(r);
...
<a name="one_random_fill_buffer"></a>

## Function `fill_buffer`



<pre><code><b>fun</b> <a href="../one/random.md#one_random_fill_buffer">fill_buffer</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">one::random::RandomGenerator</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../one/random.md#one_random_fill_buffer">fill_buffer</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>) {
    <b>let</b> next_block = <a href="../one/random.md#one_random_derive_next_block">derive_next_block</a>(g);
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_bytes">generate_bytes</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, num_of_bytes: u16): vector&lt;u8&gt; {
    ...
    <b>let</b> <b>mut</b> num_of_blocks = num_of_bytes / <a href="../one/random.md#one_random_RAND_OUTPUT_LEN">RAND_OUTPUT_LEN</a>;
    <b>while</b> (num_of_blocks &gt; 0) {
        vector::append(&<b>mut</b> result, <a href="../one/random.md#one_random_derive_next_block">derive_next_block</a>(g));
    ...
    <b>if</b> (vector::length(&g.buffer) &lt; (num_of_bytes - vector::length(&result))) {
        <a href="../one/random.md#one_random_fill_buffer">fill_buffer</a>(g);
    };
...
<a name="one_random_u256_from_bytes"></a>

## Function `u256_from_bytes`



<pre><code><b>fun</b> <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">one::random::RandomGenerator</a>, num_of_bytes: u8): u256
</code></pre>
...
<pre><code><b>fun</b> <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, num_of_bytes: u8): u256 {
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u256">generate_u256</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>): u256 {
    <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g, 32)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u128">generate_u128</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>): u128 {
    <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g, 16) <b>as</b> u128
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u64">generate_u64</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>): u64 {
    <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g, 8) <b>as</b> u64
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u32">generate_u32</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>): u32 {
    <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g, 4) <b>as</b> u32
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u16">generate_u16</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>): u16 {
    <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g, 2) <b>as</b> u16
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u8">generate_u8</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>): u8 {
    <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g, 1) <b>as</b> u8
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_bool">generate_bool</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>): bool {
    (<a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g, 1) & 1) == 1
}
</code></pre>
...
<a name="one_random_u128_in_range"></a>

## Function `u128_in_range`



<pre><code><b>fun</b> <a href="../one/random.md#one_random_u128_in_range">u128_in_range</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">one::random::RandomGenerator</a>, min: u128, max: u128, num_of_bytes: u8): u128
</code></pre>
...
<pre><code><b>fun</b> <a href="../one/random.md#one_random_u128_in_range">u128_in_range</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, min: u128, max: u128, num_of_bytes: u8): u128 {
    ...
    <b>let</b> rand = <a href="../one/random.md#one_random_u256_from_bytes">u256_from_bytes</a>(g, num_of_bytes);
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u128_in_range">generate_u128_in_range</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, min: u128, max: u128): u128 {
    <a href="../one/random.md#one_random_u128_in_range">u128_in_range</a>(g, min, max, 24)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u64_in_range">generate_u64_in_range</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, min: u64, max: u64): u64 {
    <a href="../one/random.md#one_random_u128_in_range">u128_in_range</a>(g, min <b>as</b> u128, max <b>as</b> u128, 16) <b>as</b> u64
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u32_in_range">generate_u32_in_range</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, min: u32, max: u32): u32 {
    <a href="../one/random.md#one_random_u128_in_range">u128_in_range</a>(g, min <b>as</b> u128, max <b>as</b> u128, 12) <b>as</b> u32
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u16_in_range">generate_u16_in_range</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, min: u16, max: u16): u16 {
    <a href="../one/random.md#one_random_u128_in_range">u128_in_range</a>(g, min <b>as</b> u128, max <b>as</b> u128, 10) <b>as</b> u16
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_generate_u8_in_range">generate_u8_in_range</a>(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, min: u8, max: u8): u8 {
    <a href="../one/random.md#one_random_u128_in_range">u128_in_range</a>(g, min <b>as</b> u128, max <b>as</b> u128, 9) <b>as</b> u8
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/random.md#one_random_shuffle">shuffle</a>&lt;T&gt;(g: &<b>mut</b> <a href="../one/random.md#one_random_RandomGenerator">RandomGenerator</a>, v: &<b>mut</b> vector&lt;T&gt;) {
    ...
    <b>let</b> end = n - 1;
    <b>while</b> (i &lt; end) {
        <b>let</b> j = <a href="../one/random.md#one_random_generate_u16_in_range">generate_u16_in_range</a>(g, i, end);
