...
<a name="one_tx_context_TxContext"></a>

## Struct `TxContext`

Information about the transaction currently being executed.
This cannot be constructed by a transaction--it is a privileged object created by
the VM and passed in to the entrypoint of the transaction as <code>&<b>mut</b> <a href="../one/tx_context.md#one_tx_context_TxContext">TxContext</a></code>.


<pre><code><b>public</b> <b>struct</b> <a href="../one/tx_context.md#one_tx_context_TxContext">TxContext</a> <b>has</b> drop
</code></pre>
...
<dl>
<dt>
<code><a href="../one/tx_context.md#one_tx_context_sender">sender</a>: <b>address</b></code>
</dt>
<dd>
...
<dt>
<code><a href="../one/tx_context.md#one_tx_context_epoch">epoch</a>: u64</code>
</dt>
<dd>
 The current epoch number
</dd>
<dt>
<code><a href="../one/tx_context.md#one_tx_context_epoch_timestamp_ms">epoch_timestamp_ms</a>: u64</code>
</dt>
<dd>
...
<a name="one_tx_context_sender"></a>
...
<a name="one_tx_context_digest"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/tx_context.md#one_tx_context_digest">digest</a>(self: &<a href="../one/tx_context.md#one_tx_context_TxContext">one::tx_context::TxContext</a>): &vector&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../one/tx_context.md#one_tx_context_digest">digest</a>(self: &<a href="../one/tx_context.md#one_tx_context_TxContext">TxContext</a>): &vector&lt;u8&gt; {
    &self.tx_hash
}
</code></pre>
...
<a name="one_tx_context_epoch_timestamp_ms"></a>
...
<a name="one_tx_context_fresh_object_address"></a>
...
<pre><code><b>fun</b> <a href="../one/tx_context.md#one_tx_context_ids_created">ids_created</a>(_self: &<a href="../one/tx_context.md#one_tx_context_TxContext">one::tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="../one/tx_context.md#one_tx_context_ids_created">ids_created</a>(_self: &<a href="../one/tx_context.md#one_tx_context_TxContext">TxContext</a>): u64 {
    <a href="../one/tx_context.md#one_tx_context_native_ids_created">native_ids_created</a>()
}
</code></pre>
...
<a name="one_tx_context_derive_id"></a>
