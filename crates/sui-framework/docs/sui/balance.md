...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>fun</b> <a href="../sui/balance.md#sui_balance_send_funds">send_funds</a>&lt;T&gt;(<a href="../sui/balance.md#sui_balance">balance</a>: <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;, recipient: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>fun</b> <a href="../sui/balance.md#sui_balance_send_funds">send_funds</a>&lt;T&gt;(<a href="../sui/balance.md#sui_balance">balance</a>: <a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;, recipient: <b>address</b>) {
    <a href="../sui/funds_accumulator.md#sui_funds_accumulator_add_impl">one::funds_accumulator::add_impl</a>(<a href="../sui/balance.md#sui_balance">balance</a>, recipient);
}
</code></pre>
...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>fun</b> <a href="../sui/balance.md#sui_balance_redeem_funds">redeem_funds</a>&lt;T&gt;(withdrawal: <a href="../sui/funds_accumulator.md#sui_funds_accumulator_Withdrawal">one::funds_accumulator::Withdrawal</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;&gt;): <a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>fun</b> <a href="../sui/balance.md#sui_balance_redeem_funds">redeem_funds</a>&lt;T&gt;(
    withdrawal: <a href="../sui/funds_accumulator.md#sui_funds_accumulator_Withdrawal">one::funds_accumulator::Withdrawal</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;,
...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>fun</b> <a href="../sui/balance.md#sui_balance_withdraw_funds_from_object">withdraw_funds_from_object</a>&lt;T&gt;(obj: &<b>mut</b> <a href="../sui/object.md#sui_object_UID">one::object::UID</a>, <a href="../sui/balance.md#sui_balance_value">value</a>: u64): <a href="../sui/funds_accumulator.md#sui_funds_accumulator_Withdrawal">one::funds_accumulator::Withdrawal</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">one::balance::Balance</a>&lt;T&gt;&gt;
</code></pre>
...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>fun</b> <a href="../sui/balance.md#sui_balance_withdraw_funds_from_object">withdraw_funds_from_object</a>&lt;T&gt;(
    ...
    <a href="../sui/funds_accumulator.md#sui_funds_accumulator_withdraw_from_object">one::funds_accumulator::withdraw_from_object</a>(obj, <a href="../sui/balance.md#sui_balance_value">value</a> <b>as</b> u256)
}
</code></pre>
...
<pre><code><b>public</b>(<a href="../sui/package.md#sui_package">package</a>) <b>fun</b> <a href="../sui/balance.md#sui_balance_create_supply_internal">create_supply_internal</a>&lt;T&gt;(): <a href="../sui/balance.md#sui_balance_Supply">one::balance::Supply</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../sui/balance.md#sui_balance_withdraw_from_account">withdraw_from_account</a>&lt;T&gt;(amount: u64, ctx: &TxContext): <a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt; {
    ...
    <b>let</b> withdrawal = <a href="../sui/funds_accumulator.md#sui_funds_accumulator_create_withdrawal">one::funds_accumulator::create_withdrawal</a>&lt;<a href="../sui/balance.md#sui_balance_Balance">Balance</a>&lt;T&gt;&gt;(owner, amount <b>as</b> u256);
    withdrawal.redeem()
}
</code></pre>
