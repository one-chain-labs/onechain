...
-  [Struct `ConvertingToFungibleStakedOctEvent`](#0x3_validator_ConvertingToFungibleStakedOctEvent)
-  [Struct `RedeemingFungibleStakedOctEvent`](#0x3_validator_RedeemingFungibleStakedOctEvent)
...
-  [Function `request_add_stake_no_check`](#0x3_validator_request_add_stake_no_check)
-  [Function `convert_to_fungible_staked_oct`](#0x3_validator_convert_to_fungible_staked_oct)
-  [Function `redeem_fungible_staked_oct`](#0x3_validator_redeem_fungible_staked_oct)
...
<dt>
<code>image_url: <a href="../one-framework/url.md#0x2_url_Url">url::Url</a></code>
</dt>
<dd>

</dd>
<dt>
<code>project_url: <a href="../one-framework/url.md#0x2_url_Url">url::Url</a></code>
</dt>
<dd>
...
<dt>
<code>operation_cap_id: <a href="../one-framework/object.md#0x2_object_ID">object::ID</a></code>
</dt>
<dd>
...
<a name="0x3_validator_ConvertingToFungibleStakedOctEvent"></a>
...
<pre><code><b>struct</b> <a href="validator.md#0x3_validator_ConvertingToFungibleStakedOctEvent">ConvertingToFungibleStakedOctEvent</a> <b>has</b> <b>copy</b>, drop
</code></pre>
...
<dt>
<code>staked_oct_principal_amount: <a href="../move-stdlib/u64.md#0x1_u64">u64</a></code>
</dt>
<dd>

</dd>
<dt>
<code>fungible_staked_oct_amount: <a href="../move-stdlib/u64.md#0x1_u64">u64</a></code>
</dt>
<dd>
...
<a name="0x3_validator_RedeemingFungibleStakedOctEvent"></a>
...
<pre><code><b>struct</b> <a href="validator.md#0x3_validator_RedeemingFungibleStakedOctEvent">RedeemingFungibleStakedOctEvent</a> <b>has</b> <b>copy</b>, drop
</code></pre>
...
<a name="0x3_validator_EStakedOctIsLock"></a>



<pre><code><b>const</b> <a href="validator.md#0x3_validator_EStakedOctIsLock">EStakedOctIsLock</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 203;
</code></pre>



<a name="0x3_validator_EStakedOctNotLock"></a>



<pre><code><b>const</b> <a href="validator.md#0x3_validator_EStakedOctNotLock">EStakedOctNotLock</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 204;
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_new">new</a>(
    ...
    <b>let</b> metadata = <a href="validator.md#0x3_validator_new_metadata">new_metadata</a>(
        ...
        <a href="../one-framework/url.md#0x2_url_new_unsafe_from_bytes">url::new_unsafe_from_bytes</a>(image_url),
        <a href="../one-framework/url.md#0x2_url_new_unsafe_from_bytes">url::new_unsafe_from_bytes</a>(project_url),
        ...
        <a href="../one-framework/bag.md#0x2_bag_new">bag::new</a>(ctx),
    );
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator.md#0x3_validator_request_add_stake">request_add_stake</a>(self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>, stake: <a href="../one-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../one-framework/oct.md#0x2_oct_OCT">oct::OCT</a>&gt;, staker_address: <b>address</b>, is_validator: bool, ctx: &<b>mut</b> <a href="../one-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedOct">staking_pool::StakedOct</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_request_add_stake">request_add_stake</a>(
    ...
    self.<a href="validator.md#0x3_validator_request_add_stake_no_check">request_add_stake_no_check</a>(
        stake,
        staker_address,
        is_validator,
        ctx
...
<a name="0x3_validator_request_add_stake_no_check"></a>

## Function `request_add_stake_no_check`



<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator.md#0x3_validator_request_add_stake_no_check">request_add_stake_no_check</a>(self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>, stake: <a href="../one-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../one-framework/oct.md#0x2_oct_OCT">oct::OCT</a>&gt;, staker_address: <b>address</b>, is_validator: bool, ctx: &<b>mut</b> <a href="../one-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedOct">staking_pool::StakedOct</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_request_add_stake_no_check">request_add_stake_no_check</a>(
    self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">Validator</a>,
    stake: Balance&lt;OCT&gt;,
    staker_address: <b>address</b>,
    is_validator: bool,
    ...
    <b>let</b> staked_oct = self.<a href="staking_pool.md#0x3_staking_pool">staking_pool</a>.<a href="validator.md#0x3_validator_request_add_stake">request_add_stake</a>(stake, stake_epoch, is_validator, ctx);
    ...
    <a href="../one-framework/event.md#0x2_event_emit">event::emit</a>(
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_convert_to_fungible_staked_oct">convert_to_fungible_staked_oct</a>(
    self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">Validator</a>,
    staked_oct: StakedOct,
    ctx: &<b>mut</b> TxContext,
): FungibleStakedOct {
    <b>assert</b>!(!staked_oct.lock(), <a href="validator.md#0x3_validator_EStakedOctIsLock">EStakedOctIsLock</a>);
    ...
    <b>let</b> fungible_staked_oct = self.<a href="staking_pool.md#0x3_staking_pool">staking_pool</a>.<a href="validator.md#0x3_validator_convert_to_fungible_staked_oct">convert_to_fungible_staked_oct</a>(staked_oct, ctx);

    <a href="../one-framework/event.md#0x2_event_emit">event::emit</a>(
        <a href="validator.md#0x3_validator_ConvertingToFungibleStakedOctEvent">ConvertingToFungibleStakedOctEvent</a> {
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_redeem_fungible_staked_oct">redeem_fungible_staked_oct</a>(
    self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">Validator</a>,
    ...
    <b>let</b> sui = self.<a href="staking_pool.md#0x3_staking_pool">staking_pool</a>.<a href="validator.md#0x3_validator_redeem_fungible_staked_oct">redeem_fungible_staked_oct</a>(fungible_staked_oct, ctx);

    self.next_epoch_stake = self.next_epoch_stake - sui.value();

    <a href="../one-framework/event.md#0x2_event_emit">event::emit</a>(
        <a href="validator.md#0x3_validator_RedeemingFungibleStakedOctEvent">RedeemingFungibleStakedOctEvent</a> {
            pool_id: self.<a href="validator.md#0x3_validator_staking_pool_id">staking_pool_id</a>(),
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator.md#0x3_validator_request_add_stake_at_genesis">request_add_stake_at_genesis</a>(self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>, stake: <a href="../one-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../one-framework/oct.md#0x2_oct_OCT">oct::OCT</a>&gt;, staker_address: <b>address</b>, lock: bool, ctx: &<b>mut</b> <a href="../one-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_request_add_stake_at_genesis">request_add_stake_at_genesis</a>(
    ...
    <b>let</b> staked_oct = self.<a href="staking_pool.md#0x3_staking_pool">staking_pool</a>.<a href="validator.md#0x3_validator_request_add_stake">request_add_stake</a>(
        stake,
    ...
    <a href="../one-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(staked_oct, staker_address);
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_request_withdraw_stake">request_withdraw_stake</a>(
    ...
    <b>let</b> stake_activation_epoch = staked_oct.stake_activation_epoch();
    <b>let</b> <b>mut</b> withdrawn_stake = self.<a href="staking_pool.md#0x3_staking_pool">staking_pool</a>.<a href="validator.md#0x3_validator_request_withdraw_stake">request_withdraw_stake</a>(staked_oct, ctx);
    ...
    <b>if</b>(lock){
        ...
        <b>let</b> <a href="../one-framework/coin_vesting.md#0x2_coin_vesting">coin_vesting</a> = <a href="../one-framework/coin_vesting.md#0x2_coin_vesting_new_form_balance">coin_vesting::new_form_balance</a>(
            withdrawn_stake,
            stake_activation_epoch,
        ...
        (withdrawn_reward, <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(<a href="../one-framework/coin_vesting.md#0x2_coin_vesting">coin_vesting</a>))
    }<b>else</b> {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator.md#0x3_validator_deposit_stake_rewards">deposit_stake_rewards</a>(self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>, reward: <a href="../one-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../one-framework/oct.md#0x2_oct_OCT">oct::OCT</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator.md#0x3_validator_process_pending_stakes_and_withdraws">process_pending_stakes_and_withdraws</a>(self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>, ctx: &<a href="../one-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator.md#0x3_validator_image_url">image_url</a>(self: &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>): &<a href="../one-framework/url.md#0x2_url_Url">url::Url</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator.md#0x3_validator_project_url">project_url</a>(self: &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>): &<a href="../one-framework/url.md#0x2_url_Url">url::Url</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator.md#0x3_validator_operation_cap_id">operation_cap_id</a>(self: &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>): &<a href="../one-framework/object.md#0x2_object_ID">object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator.md#0x3_validator_staking_pool_id">staking_pool_id</a>(self: &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>): <a href="../one-framework/object.md#0x2_object_ID">object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator.md#0x3_validator_staking_pool_id">staking_pool_id</a>(self: &<a href="validator.md#0x3_validator_Validator">Validator</a>): ID {
    <a href="../one-framework/object.md#0x2_object_id">object::id</a>(&self.<a href="staking_pool.md#0x3_staking_pool">staking_pool</a>)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator.md#0x3_validator_new_unverified_validator_operation_cap_and_transfer">new_unverified_validator_operation_cap_and_transfer</a>(self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>, ctx: &<b>mut</b> <a href="../one-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_update_image_url">update_image_url</a>(self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">Validator</a>, image_url: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;) {
    ...
    self.metadata.image_url = <a href="../one-framework/url.md#0x2_url_new_unsafe_from_bytes">url::new_unsafe_from_bytes</a>(image_url);
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="validator.md#0x3_validator_update_project_url">update_project_url</a>(self: &<b>mut</b> <a href="validator.md#0x3_validator_Validator">Validator</a>, project_url: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;) {
    ...
    self.metadata.project_url = <a href="../one-framework/url.md#0x2_url_new_unsafe_from_bytes">url::new_unsafe_from_bytes</a>(project_url);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="validator.md#0x3_validator_new_from_metadata">new_from_metadata</a>(metadata: <a href="validator.md#0x3_validator_ValidatorMetadata">validator::ValidatorMetadata</a>, revenue_receiving_address: <b>address</b>, only_validator_staking: bool, gas_price: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>, commission_rate: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>, ctx: &<b>mut</b> <a href="../one-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="validator.md#0x3_validator_Validator">validator::Validator</a>
</code></pre>
