...
<pre><code><b>public</b>(package) <b>fun</b> <a href="supper_committee.md#0x3_supper_committee_create_proposal">create_proposal</a>&lt;Action:store&gt;(
    ...
    // only sui_system action <b>struct</b> types
    <b>assert</b>!(action_type.get_address() == <a href="../one-framework/address.md#0x2_address_to_ascii_string">address::to_ascii_string</a>(@0x3),<a href="supper_committee.md#0x3_supper_committee_ENotSupportStructType">ENotSupportStructType</a>);
