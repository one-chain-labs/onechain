...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../one_system/validator.md#one_system_validator_request_add_stake_at_genesis">request_add_stake_at_genesis</a>(
    ...
    <b>let</b> staked_oct = self.<a href="../one_system/staking_pool.md#one_system_staking_pool">staking_pool</a>.<a href="../one_system/validator.md#one_system_validator_request_add_stake">request_add_stake</a>(stake, 0, lock, ctx); //update
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../one_system/validator.md#one_system_validator_request_withdraw_stake">request_withdraw_stake</a>(
    ...
    <b>let</b> lock = staked_oct.lock();   //add
    <b>let</b> principal_amount = staked_oct.amount();
    <b>let</b> stake_activation_epoch = staked_oct.activation_epoch();
    <b>let</b> <b>mut</b> withdrawn_stake = self.<a href="../one_system/staking_pool.md#one_system_staking_pool">staking_pool</a>.<a href="../one_system/validator.md#one_system_validator_request_withdraw_stake">request_withdraw_stake</a>(staked_oct, ctx);//update
