...
<pre><code><b>fun</b> <a href="../sui_system/genesis.md#sui_system_genesis_allocate_tokens">allocate_tokens</a>(
    ...
    <b>while</b> (!allocations.is_empty()) {
        ...
        <b>if</b> (staked_with_validator.is_some()) {
            ...
            <a href="../sui/transfer.md#sui_transfer">one::transfer</a>(
...
<pre><code><b>fun</b> <a href="../sui_system/genesis.md#sui_system_genesis_activate_validators">activate_validators</a>(validators: &<b>mut</b> vector&lt;<a href="../sui_system/validator.md#sui_system_validator_Validator">one_system::validator::Validator</a>&gt;)
</code></pre>
