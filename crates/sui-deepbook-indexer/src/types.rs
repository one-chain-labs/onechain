...
use crate::models::{
    ...
    Flashloan as DBFlashloan,
    OrderFill as DBOrderFill,
    OrderUpdate as DBOrderUpdate,
    PoolPrice as DBPoolPrice,
    Proposals as DBProposals,
    Rebates as DBRebates,
    Stakes as DBStakes,
    SuiErrorTransactions,
    TradeParamsUpdate as DBTradeParamsUpdate,
    Votes as DBVotes,
};
