...
mod checked {
    ...
    pub fn new_native_extensions<'r>(
        ...
        extensions.add(ObjectRuntime::new(child_resolver, input_objects, is_metered, protocol_config, metrics));
    ...
    pub fn run_metered_move_bytecode_verifier(
        ...
        for module in modules.iter() {
            ...
            if let Err(e) = verify_module_with_config_metered(verifier_config, module, meter) {
                ...
                sui_verify_module_metered_check_timeout_only(protocol_config, module, &BTreeMap::new(), meter)
            {
