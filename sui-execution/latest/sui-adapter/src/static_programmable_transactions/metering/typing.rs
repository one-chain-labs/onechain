...
use crate::static_programmable_transactions::{metering::translation_meter::TranslationMeter, typing::ast as T};
...
pub fn meter(meter: &mut TranslationMeter, transaction: &T::Transaction) -> Result<(), ExecutionError> {
