...
const NATIVE_PACKAGE_IDS: &[ObjectID] = &[SUI_FRAMEWORK_PACKAGE_ID, SUI_SYSTEM_PACKAGE_ID, MOVE_STDLIB_PACKAGE_ID];
    ...
    pub(crate) fn resolution_table_with_native_packages(
        ...
        if self.always_include_system_packages {
            for id in NATIVE_PACKAGE_IDS {
                ...
                resolution_table.all_versions_resolution_table.insert(*id, *id);
            }
        }
