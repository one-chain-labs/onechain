...
mod checked {
    ...
    use sui_types::{
        balance::{BALANCE_MODULE_NAME, SEND_TO_ACCOUNT_FUNCTION_NAME, WITHDRAW_FROM_ACCOUNT_FUNCTION_NAME},
        base_types::{
            MoveLegacyTxContext,
            MoveObjectType,
            ObjectID,
    ...
    fn check_visibility_and_signature<Mode: ExecutionMode>(
        ...
        let function_kind = match (fdef.visibility, fdef.is_entry) {
            ...
            (Visibility::Private | Visibility::Friend, false) => {
                ...
                if context.protocol_config.allow_private_accumulator_entrypoints() {
