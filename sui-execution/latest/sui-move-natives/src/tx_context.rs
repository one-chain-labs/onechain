...
use crate::{object_runtime::ObjectRuntime, transaction_context::TransactionContext, NativesCostTable};
...
pub fn fresh_id(
    ...
    let tx_context_fresh_id_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_fresh_id_cost_params.clone();
...
pub fn sender(context: &mut NativeContext, ty_args: Vec<Type>, args: VecDeque<Value>) -> PartialVMResult<NativeResult> {
    ...
    let tx_context_sender_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_sender_cost_params.clone();
...
pub fn epoch(context: &mut NativeContext, ty_args: Vec<Type>, args: VecDeque<Value>) -> PartialVMResult<NativeResult> {
    ...
    let tx_context_epoch_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_epoch_cost_params.clone();
...
pub fn epoch_timestamp_ms(
    ...
    let tx_context_epoch_timestamp_ms_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_epoch_timestamp_ms_cost_params.clone();
...
pub fn sponsor(context: &mut NativeContext, ty_args: Vec<Type>, args: VecDeque<Value>) -> PartialVMResult<NativeResult> {
    ...
    let tx_context_sponsor_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_sponsor_cost_params.clone();
...
pub fn gas_price(
    ...
    let tx_context_gas_price_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_gas_price_cost_params.clone();
...
pub fn gas_budget(
    ...
    let tx_context_gas_budget_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_gas_budget_cost_params.clone();
...
pub fn ids_created(
    ...
    let tx_context_ids_created_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_ids_created_cost_params.clone();
...
pub fn replace(
    ...
    let tx_context_replace_cost_params =
        context.extensions_mut().get::<NativesCostTable>()?.tx_context_replace_cost_params.clone();
