...
- [`one::url`](/references/framework/sui_sui/url.md)

- [`one::url` source code](https://github.com/one-chain-labs/onechain/blob/c5f8b33b8090d75b1922f1497916b4010d9140d7/crates/sui-framework/sources/url.move).
...
- [Error definition](https://github.com/one-chain-labs/onechain/blob/63cbf0dc26d0f2329d3e0a03639e31ded9f93561/crates/sui-graphql-e2e-tests/tests/stable/errors/clever_errors.snap)
...
- [Error definition](https://github.com/one-chain-labs/onechain/blob/63cbf0dc26d0f2329d3e0a03639e31ded9f93561/crates/sui-adapter-transactional-tests/tests/sui/publish_module_non_zero_address.snap)
...
- [Error definition](https://github.com/one-chain-labs/onechain/blob/63cbf0dc26d0f2329d3e0a03639e31ded9f93561/external-crates/move/crates/bytecode-verifier-transactional-tests/tests/script_signature/signer_double_signer.snap)
...
- [Error: `ZERO_SIZED_STRUCT`](https://github.com/one-chain-labs/onechain/blob/63cbf0dc26d0f2329d3e0a03639e31ded9f93561/crates/sui-verifier-transactional-tests/tests/one_time_witness/no_field.snap)

- [Error: `FIELD_MISSING_TYPE_ABILITY`](https://github.com/one-chain-labs/onechain/blob/63cbf0dc26d0f2329d3e0a03639e31ded9f93561/crates/sui-verifier-transactional-tests/tests/struct_with_key/key_struct_with_drop.snap)

- [Error: `CONSTRAINT_NOT_SATISFIED`](https://github.com/one-chain-labs/onechain/blob/63cbf0dc26d0f2329d3e0a03639e31ded9f93561/crates/sui-verifier-transactional-tests/tests/private_generics/receive_without_key.snap)
