...
You can view the [complete source code for this app example](https://github.com/one-chain-labs/onechain/tree/main/examples/tic-tac-toe) in the Sui repository.
...
To view the entire source code, see the [owned.move source file](https://github.com/one-chain-labs/onechain/blob/main/examples/tic-tac-toe/move/sources/owned.move). You can find the rest of the logic, including how to check for a winner, as well as deleting the game board after the game concludes there.
...
You can find an example React front-end supporting both the multi-sig and shared variants of the game in the [ui directory](https://github.com/one-chain-labs/onechain/blob/main/examples/tic-tac-toe/ui), and a CLI written in Rust in the [cli directory](https://github.com/one-chain-labs/onechain/blob/main/examples/tic-tac-toe/cli).
