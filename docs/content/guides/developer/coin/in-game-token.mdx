...
keywords: [ closed-loop tokens, closed-loop, closed loop, in-game tokens, in-game currency, game currency, token example, create a token, how to create token, OCT token standards ]
---
...
<RelatedLink href="https://github.com/one-chain-labs/onechain/blob/main/examples/move/token/sources/gems.move" label="Source code" desc="The source code in GitHub for this example." />
