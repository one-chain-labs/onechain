...
keywords: [ closed-loop tokens, closed-loop, closed loop, loyalty tokens, token example, create a token, how to create token, OCT token standards ]
---
...
<RelatedLink href="https://github.com/one-chain-labs/onechain/blob/main/examples/move/token/sources/loyalty.move" label="Source code" desc="The source code in GitHub for this example." />
