...
keywords: [ regulated coin list, regulated coins, regulate coin, allow list, deny list, stablecoins, token example, create a token, how to create token, OCT token standards, coin registry ]
---
...
The Coin Registry system provides enhanced regulatory features through the `one::coin_registry` module:
...
For all `Coin` functions available, see the Sui framework [`coin` module documentation](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-framework/docs/sui/coin.md). The following functions are the most common. 
...
<ImportContent source="crates/sui-framework/packages/one-framework/sources/coin.move" mode="code" fun="mint" />
...
<ImportContent source="crates/sui-framework/packages/one-framework/sources/coin.move" mode="code" fun="mint_balance" />
...
<ImportContent source="crates/sui-framework/packages/one-framework/sources/coin.move" mode="code" fun="mint_and_transfer" />
...
<ImportContent source="crates/sui-framework/packages/one-framework/sources/coin.move" mode="code" fun="burn" />
...
<RelatedLink href="https://github.com/one-chain-labs/onechain/tree/main/examples/regulated-coin" label="Source code" desc="The source code in GitHub for this example." />
