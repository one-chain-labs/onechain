...
For all `Coin` functions available, see the Sui framework [`coin` module documentation](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-framework/docs/sui-framework/coin.md).

## Related links

- [Closed Loop Token standard](../../../standards/closed-loop-token.mdx): Details for the standard used to create tokens on Sui.
- [Source code](https://github.com/one-chain-labs/onechain/blob/main/examples/move/coin/sources/regcoin.move): The source code in GitHub for this example.
