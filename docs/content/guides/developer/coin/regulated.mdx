...
For all `Coin` functions available, see the Sui framework [`coin` module documentation](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-framework/docs/sui/coin.md).
