...
Sui offers three networks: Mainnet, Devnet, and Testnet. You can use one of the test networks, Devnet or Testnet, to experiment with the version of Sui running on that network. You can also spin up a [local Sui network](./local-network.mdx) for local development. 
...
See the [Sui Releases](https://github.com/one-chain-labs/onechain/releases) page to view the changes in each Sui release.
