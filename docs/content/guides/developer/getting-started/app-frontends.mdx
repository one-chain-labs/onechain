...
First, confirm that you have [followed the "Hello, World!"](https://github.com/one-chain-labs/onechain-stack-hello-world.git) example guide and are within the `sui-stack-hello-world/move/hello-world` directory in your CLI.
...
If your package no longer exists, or if you need to obtain the package ID again, follow the steps in the ["Hello, World!"](https://github.com/one-chain-labs/onechain-stack-hello-world.git) guide.
...
## Send OCT tokens to your Slush wallet

If you sent OCT tokens to an address used in the CLI in previous guides, then created a new Slush wallet in your browser, you likely need to send OCT tokens to the Slush wallet. The Slush wallet address is different and separate from the address created and used in the CLI.
