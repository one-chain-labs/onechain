...
Sui faucet is a helpful tool where Sui developers can get free test OCT tokens to deploy and interact with their programs on Sui's Devnet and Testnet networks. There is no faucet for Sui Mainnet...

## Prerequisites

To request tokens from the faucet, you must own a wallet address that can receive the OCT tokens. See the [Get Sui Address](./get-address.mdx) topic if you don't already have an address or need to create a new one.

## Request test tokens through the online faucet {#online-faucet}

https://faucet.sui.io/: Visit the online faucet to request OCT tokens.
...
1. Request test OCT tokens in the Sui [#devnet-faucet](https://discord.com/channels/916379725201563759/971488439931392130) or [#testnet-faucet](https://discord.com/channels/916379725201563759/1037811694564560966) Discord channels. Send the following message to the channel with your client address:
