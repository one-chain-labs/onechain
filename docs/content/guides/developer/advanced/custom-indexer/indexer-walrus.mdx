...
<RelatedLink href="https://github.com/one-chain-labs/onechain/tree/main/examples/rust/walrus-attributes-indexer" label="Indexer with Walrus example files" desc="Directory in the Sui repo containing the files for this example." />
