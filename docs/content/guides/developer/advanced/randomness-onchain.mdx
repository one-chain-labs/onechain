...
<RelatedLink href="https://github.com/one-chain-labs/onechain/blob/main/examples/move/random/raffles" label="Raffle example" desc="GitHub repo containing a raffle smart contract demonstrating randomness." />
