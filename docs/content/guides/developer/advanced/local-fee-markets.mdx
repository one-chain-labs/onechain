...
1. Estimates each transaction's execution cost using the [`ExecutionTimeEstimate`](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-core/src/authority/execution_time_estimator.rs) heuristic.
