...
<RelatedLink href="https://github.com/one-chain-labs/onechain/tree/main/examples/move/nft-soulbound" label="Soulbound NFT example source code" desc="The source code that this document references." />
