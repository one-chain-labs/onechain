...
- [Soulbound NFT example source code](https://github.com/one-chain-labs/onechain/tree/main/examples/move/nft-soulbound): The source code that this document references.
