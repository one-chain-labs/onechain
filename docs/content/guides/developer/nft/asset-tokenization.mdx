...
You can find a public facing reference to the WASM library in the [move-binary-format-wasm](https://github.com/one-chain-labs/onechain/tree/main/sdk/move-binary-format-wasm) Sui repo subfolder.
