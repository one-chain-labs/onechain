...
- Use the [`one::test_utils`](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-framework/packages/one-framework/sources/test/test_utils.move#L5) module for debug printing via `print`, and test-only destruction via `destroy`.
