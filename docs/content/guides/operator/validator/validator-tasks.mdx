...
- If you are using Docker Compose, look at the [examples in the README](https://github.com/one-chain-labs/onechain/blob/main/nre/docker/README.md#logs).
...
You can leverage the [validator tool](https://github.com/one-chain-labs/onechain/blob/main/nre/validator_tool.md) to perform a majority of the following tasks.
...
See the [full list of metadata update functions](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-framework/packages/one-system/sources/sui_system.move#L267-L444).
