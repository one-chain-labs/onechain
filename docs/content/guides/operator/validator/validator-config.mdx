...
For more information on deploying a validator, refer to the [Sui for Node Operators](https://github.com/one-chain-labs/onechain/blob/main/nre/sui_for_node_operators.md) guide.
...
For more information on configuring a validator, refer to the [Sui for Node Operators](https://github.com/one-chain-labs/onechain/blob/main/nre/sui_for_node_operators.md) guide.
