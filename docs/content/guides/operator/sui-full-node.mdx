...
You must enable gRPC support on your full nodes. JSON-RPC is **deprecated**. Refer to [Sui's data serving roadmap](/concepts/data-access/data-serving.mdx#grpc-api) for guidance on the overall transition plan.
...
There's a guide in the Sui repository on running a full node via [Docker Compose](https://github.com/one-chain-labs/onechain/tree/main/docker/fullnode#readme). 
...
1. Make a copy of the [full node YAML template](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-config/data/fullnode-template.yaml):
    ```sh
    $ cp crates/sui-config/data/fullnode-template.yaml fullnode.yaml
    ```
1. Download the genesis blob for the network to use:
    - [Devnet genesis blob](https://github.com/one-chain-labs/onechain-genesis/raw/main/devnet/genesis.blob):
        ```sh
        $ curl -fLJO https://github.com/one-chain-labs/onechain-genesis/raw/main/devnet/genesis.blob
        ```
    - [Testnet genesis blob](https://github.com/one-chain-labs/onechain-genesis/raw/main/testnet/genesis.blob):
        ```sh
        $ curl -fLJO https://github.com/one-chain-labs/onechain-genesis/raw/main/testnet/genesis.blob
        ```
    - [Mainnet genesis blob](https://github.com/one-chain-labs/onechain-genesis/raw/main/mainnet/genesis.blob):
        ```sh
        $ curl -fLJO https://github.com/one-chain-labs/onechain-genesis/raw/main/mainnet/genesis.blob
        ```
