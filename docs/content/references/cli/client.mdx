...
Commands:
  ...
  transfer-oct                Transfer SUI, and pay gas with the same OCT coin object. If amount is specified, only the amount is transferred; otherwise the entire object is transferred
...
│  │ Sender: 0x0fe375fff0ee40d20c54a7f2478b9b5c7eaa3625b7611f9661ec5faefb4a6fea                    │
│  │ Owner: Account Address ( 0x3d78abc33ccd173c521b4f9e78b21ea2c989960b631732c539efaa38bda30976 ) │
│  │ ObjectType: 0x2::coin::Coin<0x2::one::OCT>                                                    │
│  │ Version: 3                                                                                    │
│  │ Digest: Fq3maqq3pShgKw58Ssm8cS2j1pspfhanedVK2MMxfQWQ                                          │
│  └──                                                                                             │
│ Mutated Objects:                                                                                 │
...
If you want to transfer the whole object, you can use `sui client pay-all-oct` or `sui client transfer-oct` (without passing the amount): 
```sh
