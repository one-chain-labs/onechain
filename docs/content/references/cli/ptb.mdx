...
Options:
      ...
      --make-move-vec <TYPE> <[VALUES]>
          ...
          Examples:
           ...
           --make-move-vec <one::coin::Coin<one::one::SUI>> [gas]
...
--assign coins
--move-call one::coin::destroy_zero<one::one::SUI> coins.0
...
--move-call one::coin::destroy_zero<one::one::SUI> zcoins.0
--move-call one::coin::destroy_zero<one::one::SUI> zcoins.1
