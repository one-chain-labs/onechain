...
<table class="w-100">
	...
	<tbody>
		<tr>
			...
			<td class="w-1/3">Get a OCT coin from the faucet associated with the active network</td>
		</tr>
		<tr>
			<td class="w-2/3">`sui client faucet --address ADDRESS`</td>
			<td class="w-1/3">Get a OCT coin for the address (accepts also an alias)</td>
		</tr>
		<tr>
			<td class="w-2/3">`sui client faucet --url CUSTOM_FAUCET_URL`</td>
			<td class="w-1/3">Get a OCT coin from custom faucet</td>
		</tr>
		<tr>
...
<table class="w-100">
	...
	<tbody>
		<tr>
			<td class="w-2/3">`one move build`</td>
			<td class="w-1/3">Build the Move project in the current directory</td>
		</tr>
		<tr>
			<td class="w-2/3">`one move build --path PATH`</td>
