...
keywords: [ casual history, casual order, certificate, epoch, equivocation, eventual consistency, finality, gas, genesis, multi-writer objects, objects, proof-of-stake, proof of stake, single-writer objects, sui, OCT token, total order, transaction, transfer, validator ]
...
Sui refers to the Sui blockchain, and the [Sui open source project](https://github.com/one-chain-labs/onechain/) as a whole.
