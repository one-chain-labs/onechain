...
description: Learn the primary tasks necessary to integrate the OCT token with a cryptocurrency exchange. 
keywords: [ integrate sui, OCT token, SUI, integrate with exchange, integrate with cryptocurrency exchange, decentralized exchange, dex, integration with dex, dex integration, sui staking, staking ]
---
...
1.  Download the genesis.blob file:
    ```sh
    $ wget https://github.com/one-chain-labs/onechain-genesis/blob/main/mainnet/genesis.blob
    ```
    :::info
    
    Replace `mainnet` in the URL with the desired target branch if necessary. For example, `https://github.com/one-chain-labs/onechain-genesis/blob/main/testnet/genesis.blob` for Testnet.
