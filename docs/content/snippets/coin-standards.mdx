...
<ImportContent source="crates/sui-framework/packages/one-framework/sources/coin.move" mode="code" fun="deny_list_v2_enable_global_pause" noComments signatureOnly />
...
<ImportContent source="crates/sui-framework/packages/one-framework/sources/coin.move" mode="code" fun="deny_list_v2_disable_global_pause" noComments signatureOnly  />