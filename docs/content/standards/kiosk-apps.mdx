...
- [NFT Rental repository](https://github.com/one-chain-labs/onechain/tree/main/examples/move/nft-rental): GitHub repo that contains the source code for the NFT Rental app.
