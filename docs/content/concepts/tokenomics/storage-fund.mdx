...
- It creates deflationary pressure over the OCT token in that increased activity leads to larger storage requirements and to more SUI being removed from circulation.
