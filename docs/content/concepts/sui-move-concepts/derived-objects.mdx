...
<ImportContent source="crates/sui-framework/packages/one-framework/sources/derived_object.move" mode="code" />
</details>
...
<RelatedLink href="https://github.com/one-chain-labs/onechain/tree/main/examples/move/profiles" label="Profiles example" desc="An example smart contract that creates profiles using derived objects." />
...
<RelatedLink href="https://github.com/one-chain-labs/onechain/blob/main/crates/sui-framework/packages/one-framework/sources/derived_object.move" label="`derived_object` module" desc="The code that defines derived objects on Sui." />