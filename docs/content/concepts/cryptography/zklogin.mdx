...
- **Accessibility:** zkLogin is one of several native Sui signature schemes thanks to [Sui cryptography agility](/concepts/transactions/transaction-auth.mdx). It integrates with other Sui primitives, such as sponsored transactions and multisig.  
