...
You can use one of the following functions (defined in the [transfer module](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-framework/packages/one-framework/sources/transfer.move)) to create address-owned objects.
...
```move
one::transfer::public_transfer(C, @0xB0B);
```
