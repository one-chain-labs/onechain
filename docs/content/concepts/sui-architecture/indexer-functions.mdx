...
Refer to the [Sui Indexer README](https://github.com/one-chain-labs/onechain/tree/main/crates/sui-indexer) in the `crates/sui-indexer` directory of the Sui repo to run an indexer with a local or managed Postgres-compatible database. 
