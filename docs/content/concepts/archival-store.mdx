...
- Tool: [sui-kv-store](https://github.com/one-chain-labs/onechain/tree/main/crates/sui-kvstore)
...
- Reference implementation for Bigtable: [sui-kv-rpc](https://github.com/one-chain-labs/onechain/tree/main/crates/sui-kv-rpc).
