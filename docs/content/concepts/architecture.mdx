...
Sui uses a delegated proof-of-stake (DPoS) consensus mechanism to validate transactions. Validators must stake OCT tokens on the network, either their own or delegated by other token holders, to participate in consensus. This approach aligns validator incentives with network security and efficiency without the high energy costs of proof-of-work systems.
