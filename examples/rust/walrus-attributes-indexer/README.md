...
As of writing, the SequentialConfig is defined [here](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-indexer-alt-framework/src/pipeline/sequential/mod.rs#L68) consisting of a committer config and a checkpoint lag. The default values set `checkpoint_lag` to 0, and the committer config as follows:
```
...
The ingestion config is defined [here](https://github.com/one-chain-labs/onechain/blob/main/crates/sui-indexer-alt-framework/src/ingestion/mod.rs#L59) with defaults configured to:
```
