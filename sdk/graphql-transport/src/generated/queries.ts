...
export type IMoveObject = {
   ...
   */
  dynamicObjectField?: Maybe<DynamicField>;
  /** Determines whether a transaction can transfer this object, using the TransferObjects transaction command or `one::transfer::public_transfer`, both of which require the object to have the `key` and `store` abilities. */
  hasPublicTransfer: Scalars['Boolean']['output'];
};
